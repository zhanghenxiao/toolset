...
---
专注于分享经过验证的开发技巧与实用资源，致力于为你节省检索信息的时间，以及AI工具经验分享获取更多干货。关注微信公众号：流氓也是种气质Cookie
`},{id:9,slug:"mapbox-3d-map",title:"Mapbox GL JS 初始化 3D 建筑与地形教程",image:k,date:"2026-04-03",author:"流氓",views:"1,100",category:"教程",duration:"12:30",excerpt:"学习如何使用 Mapbox GL JS 快速初始化一个包含 3D 建筑挤压（Fill-Extrusion）和数字高程模型（DEM）地形的交互式 3D 地图。",tags:[{name:"Mapbox",type:"blue"},{name:"3D地图",type:"blue"},{name:"WebGIS",type:"green"}],collection:"地图",relatedIds:[10,12,14],recommendationIds:[10,11,12,13],gallery:[k],markdownContent:`
mapbox初始化一个3D地图
...
\`\`\`
`+g},{id:10,slug:"chrome-cors-plugin",title:"Chrome & Firefox 跨域插件配置教程",image:rt,date:"2026-04-02",author:"流氓",views:"1,800",category:"教程",duration:"08:15",excerpt:"本地开发遇到 Cross-Origin 跨域问题？通过 Chrome 和 Firefox 插件轻松开启 Access-Control-Allow-Origin，加速前后端调试。",tags:[{name:"Chrome",type:"blue"},{name:"插件",type:"blue"},{name:"跨域",type:"green"}],collection:"流氓工具箱",relatedIds:[11,12,14,15],recommendationIds:[11,12,13,14],gallery:[],markdownContent:`
## 1.Chrome跨域插件配置
...
`+g},{id:12,slug:"offline-leaflet-map",title:"Leaflet 离线地图下载与加载教程",image:nt,date:"2026-04-02",author:"流氓",views:"1,200",category:"教程",duration:"10:00",excerpt:"本教程详细介绍了下载离线地图瓦片的两种方式（osm 和 MapTileDownloader），并提供了在 Leaflet 中加载离线地图的代码示例。",tags:[{name:"Leaflet",type:"blue"},{name:"地图",type:"blue"}],collection:"流氓工具箱",relatedIds:[22,23,24],recommendationIds:[13,14,15,16],gallery:[],markdownContent:`
