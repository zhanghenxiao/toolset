...
`+l},{id:12,slug:"offline-leaflet-map",title:"Leaflet 离线地图下载与加载教程",image:ce,date:"2026-04-02",author:"数维探索",views:"1,200",category:"教程",duration:"10:00",excerpt:"本教程详细介绍了下载离线地图瓦片的两种方式（osm 和 MapTileDownloader），并提供了在 Leaflet 中加载离线地图的代码示例。",tags:[{name:"Leaflet",type:"blue"},{name:"地图",type:"blue"}],collection:"数维探索工具箱",relatedIds:[13,1,2],recommendationIds:[1,2,3,11],gallery:[],markdownContent:`
...
`+l},{id:15,slug:"web-worker-vs-service-worker",title:"Web Worker vs Service Worker：多线程与离线缓存深度对比（含PWA实战）",image:pe,date:"2026-04-21",author:"数维探索",views:"1,000",category:"教程",duration:"12:00",excerpt:"深入对比 Web Worker 与 Service Worker 的核心区别：前者专注 CPU 密集型后台计算，后者充当网络代理实现离线缓存与 PWA。本文含完整代码示例与 PWA 实战项目结构。",tags:[{name:"Web Worker",type:"blue"},{name:"Service Worker",type:"blue"},{name:"PWA",type:"green"}],collection:"数维探索工具箱",relatedIds:[4,9,10],recommendationIds:[4,9,10,12],gallery:["/15/1.png"],markdownContent:` **Web Worker** 和 **Service Worker** 都是浏览器提供的 JavaScript 多线程技术，但它们的用途和工作方式有显著区别。
...
`+l},{id:16,slug:"karpathy-ai-coding-rules",title:"GitHub 6万星！Karpathy 的 AI 编码铁律：如何让 AI 乖乖写代码（附 Antigravity Knowledge 配置教程）",image:me,date:"2026-04-22",author:"数维探索",views:"8,623",category:"教程",duration:"08:00",excerpt:"GitHub 趋势榜第一、Star 破6万的 AI 编码规范项目——基于 Karpathy 经验的4条铁律，配合 Antigravity Knowledge 全局配置，让 AI 写出更可控的代码。",tags:[{name:"AI工具",type:"blue"},{name:"Antigravity",type:"blue"},{name:"CLAUDE.md",type:"green"}],collection:"AI百科",relatedIds:[1,2,5],recommendationIds:[1,5,14,2],gallery:[],markdownContent:`这是目前 GitHub 前端/AI 圈最火的方向。因为大家都在用 AI 写代码，发现 AI 容易"放飞自我"（写得太复杂、乱改代码），所以大神们总结了一套**"如何让 AI 乖乖写代码"**的知识库。
...
`+l},{id:18,slug:"ai-knowledge-advanced-management",title:"AI 知识库实战：分类管理进阶与三大核心配置模板",image:he,date:"2026-04-22",author:"数维探索",views:"5,102",category:"教程",duration:"07:00",excerpt:"将 AI 规则拆分为前端规范、接口文档和设计系统，附赠直接可用的高频 API 模板与 Tailwind UI/UX 原则，让 AI 秒变全能前端助手。",tags:[{name:"AI知识库",type:"blue"},{name:"前沿趋势",type:"green"}],collection:"AI百科",relatedIds:[17,16],recommendationIds:[17,16,5,14],gallery:[],markdownContent:`### 💡 进阶技巧：分类管理
...
- 层级
  ...
  - 模态框: \`z-50\`。
  - 提示条: \`z-50\`。
`+l},{id:19,slug:"global-skill-configuration-uipro",title:"全局技能配置实战：如何在所有项目中通用 UI-UX Pro Max",image:ve,date:"2026-04-22",author:"数维探索",views:"2,109",category:"教程",duration:"06:00",excerpt:"深入解析 Antigravity 技能架构的“全局库+项目引用”模式，两步实现在任意项目中全局调用 UI-UX Pro Max 技能，彻底解放生产力。",tags:[{name:"AI工具",type:"blue"},{name:"开发指南",type:"green"}],collection:"AI百科",relatedIds:[18,17],recommendationIds:[18,17,16,5],gallery:[],markdownContent:`要在**所有项目**中都使用 \`UI-UX Pro Max Skill\`，你需要理解 Antigravity 的技能架构是**"全局库 + 项目级引用"**的模式。
...
`+l},{id:21,slug:"antigravity-v1-23-2-rules-troubleshooting",title:"Google Antigravity v1.23.2 项目规则不显示排查方案",image:F,date:"2026-05-08",author:"数维探索",views:"1,050",category:"教程",duration:"05:30",excerpt:"针对 Google Antigravity v1.23.2 版本中项目规则（Workspace Rules）无法加载或不显示的问题，提供了一套详尽的排查与修复方案，涵盖路径规范、UI 配置及已知 Bug 处理。",tags:[{name:"Antigravity",type:"blue"},{name:"故障排查",type:"green"},{name:"项目规则",type:"blue"}],collection:"AI百科",relatedIds:[1,5,20],recommendationIds:[5,18,19,20],gallery:[F],markdownContent:`
