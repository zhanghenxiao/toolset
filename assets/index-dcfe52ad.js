...
`+i},{id:7,slug:"llm-open-source-panic",title:"AI开源大模型LLM的“闭源”恐慌: 一场虚惊还是行业趋势的开端?",image:q,date:"2026-04-07",author:"数维探索",views:"1,500",category:"新闻",duration:"06:30",excerpt:"近期，AI 社区中流传着一个令人不安的消息: 许多主流的开源大语言模型（LLM）可能会转向闭源。这个传闻并非空穴来风，本文将带你深入探究这一话题的来龙去脉。",tags:[{name:"AI趋势",type:"blue"},{name:"LLM",type:"blue"},{name:"开源",type:"green"}],collection:"AI百科",relatedIds:[8,12,14],recommendationIds:[12,14,15,2],gallery:[q],markdownContent:`
...
`+i},{id:8,slug:"claude-opus-4-6-antigravity",title:"Claude Opus 4.6 登陆 Antigravity: 是完整升级还是“残血版”? Pro 用户上手初体验",image:w,date:"2026-04-07",author:"数维探索",views:"1,000",category:"评测",duration:"08:00",excerpt:"备受期待的 Claude Opus 4.6 模型终于在 Google 的 AI IDE 平台 Antigravity 上线! 本视频将为你详细解析更新内容及1M上下文测试。",tags:[{name:"Claude",type:"blue"},{name:"Opus 4.6",type:"blue"},{name:"Antigravity",type:"green"}],collection:"AI百科",relatedIds:[1,9,10],recommendationIds:[1,10,12,14],gallery:[w],markdownContent:`
...
`+i},{id:9,slug:"mapbox-3d-map",title:"Mapbox GL JS 初始化 3D 建筑与地形教程",image:S,date:"2026-04-03",author:"数维探索",views:"1,100",category:"教程",duration:"12:30",excerpt:"学习如何使用 Mapbox GL JS 快速初始化一个包含 3D 建筑挤压（Fill-Extrusion）和数字高程模型（DEM）地形的交互式 3D 地图。",tags:[{name:"Mapbox",type:"blue"},{name:"3D地图",type:"blue"},{name:"WebGIS",type:"green"}],collection:"地图",relatedIds:[10,11,12],recommendationIds:[10,11,12,1],gallery:[S],markdownContent:`
mapbox初始化一个3D地图
...
`+i},{id:12,slug:"offline-leaflet-map",title:"Leaflet 离线地图下载与加载教程",image:pt,date:"2026-04-02",author:"数维探索",views:"1,200",category:"教程",duration:"10:00",excerpt:"本教程详细介绍了下载离线地图瓦片的两种方式（osm 和 MapTileDownloader），并提供了在 Leaflet 中加载离线地图的代码示例。",tags:[{name:"Leaflet",type:"blue"},{name:"地图",type:"blue"}],collection:"数维探索工具箱",relatedIds:[13,1,2],recommendationIds:[1,2,7,11],gallery:[],markdownContent:`
...
- 历史系统调试
- 学习和研究用途
`+i},{id:14,slug:"google-antigravity-2026-guide",title:"Google Antigravity：2026 年 AI 编程终极指南",image:L,date:"2026-04-16",author:"数维探索",views:"1,200",category:"教程",duration:"12:00",excerpt:"Google 于 2025 年底发布的 Agent-First IDE，原生支持 Gemini 3 Pro 和 Claude Sonnet 4.5，开启 Vibe Coding 全栈自动化新纪元。",tags:[{name:"Antigravity",type:"blue"},{name:"AI工具",type:"blue"},{name:"开发指南",type:"green"}],collection:"AI百科",relatedIds:[1,2,9,13],recommendationIds:[2,7,9,13],gallery:[L],markdownContent:`
...
`+i},{id:15,slug:"web-worker-vs-service-worker",title:"Web Worker vs Service Worker：多线程与离线缓存深度对比（含PWA实战）",image:ht,date:"2026-04-21",author:"数维探索",views:"1,000",category:"教程",duration:"12:00",excerpt:"深入对比 Web Worker 与 Service Worker 的核心区别：前者专注 CPU 密集型后台计算，后者充当网络代理实现离线缓存与 PWA。本文含完整代码示例与 PWA 实战项目结构。",tags:[{name:"Web Worker",type:"blue"},{name:"Service Worker",type:"blue"},{name:"PWA",type:"green"}],collection:"数维探索工具箱",relatedIds:[4,9,10],recommendationIds:[4,9,10,12],gallery:["/15/1.png"],markdownContent:` **Web Worker** 和 **Service Worker** 都是浏览器提供的 JavaScript 多线程技术，但它们的用途和工作方式有显著区别。
...
`+i},{id:16,slug:"karpathy-ai-coding-rules",title:"GitHub 6万星！Karpathy 的 AI 编码铁律：如何让 AI 乖乖写代码（附 Antigravity Knowledge 配置教程）",image:gt,date:"2026-04-22",author:"数维探索",views:"8,623",category:"教程",duration:"08:00",excerpt:"GitHub 趋势榜第一、Star 破6万的 AI 编码规范项目——基于 Karpathy 经验的4条铁律，配合 Antigravity Knowledge 全局配置，让 AI 写出更可控的代码。",tags:[{name:"AI工具",type:"blue"},{name:"Antigravity",type:"blue"},{name:"CLAUDE.md",type:"green"}],collection:"AI百科",relatedIds:[1,2,5],recommendationIds:[1,5,14,2],gallery:[],markdownContent:`这是目前 GitHub 前端/AI 圈最火的方向。因为大家都在用 AI 写代码，发现 AI 容易"放飞自我"（写得太复杂、乱改代码），所以大神们总结了一套**"如何让 AI 乖乖写代码"**的知识库。
...
`+i},{id:18,slug:"ai-knowledge-advanced-management",title:"AI 知识库实战：分类管理进阶与三大核心配置模板",image:bt,date:"2026-04-22",author:"数维探索",views:"5,102",category:"教程",duration:"07:00",excerpt:"将 AI 规则拆分为前端规范、接口文档和设计系统，附赠直接可用的高频 API 模板与 Tailwind UI/UX 原则，让 AI 秒变全能前端助手。",tags:[{name:"AI知识库",type:"blue"},{name:"前沿趋势",type:"green"}],collection:"AI百科",relatedIds:[17,16],recommendationIds:[17,16,5,14],gallery:[],markdownContent:`### 💡 进阶技巧：分类管理
...
- 层级
  ...
  - 模态框: \`z-50\`。
  - 提示条: \`z-50\`。
`+i},{id:19,slug:"global-skill-configuration-uipro",title:"全局技能配置实战：如何在所有项目中通用 UI-UX Pro Max",image:wt,date:"2026-04-22",author:"数维探索",views:"2,109",category:"教程",duration:"06:00",excerpt:"深入解析 Antigravity 技能架构的“全局库+项目引用”模式，两步实现在任意项目中全局调用 UI-UX Pro Max 技能，彻底解放生产力。",tags:[{name:"AI工具",type:"blue"},{name:"开发指南",type:"green"}],collection:"AI百科",relatedIds:[18,17],recommendationIds:[18,17,16,5],gallery:[],markdownContent:`要在**所有项目**中都使用 \`UI-UX Pro Max Skill\`，你需要理解 Antigravity 的技能架构是**"全局库 + 项目级引用"**的模式。
...
`+i},{id:20,slug:"google-antigravity-download-v1-23-2",title:"Google Antigravity 最新稳定版 v1.23.2 全平台免费下载 (官方正版)",image:M,date:"2026-05-08",author:"数维探索",views:"1,200",category:"教程",duration:"06:00",excerpt:"Google Antigravity 是 2025 年推出的 AI 原生 IDE，内置 Gemini 3.1 Pro，支持多模型切换与智能体自主开发。本文提供 v1.23.2 最新稳定版的各平台下载地址及安装配置指南。",tags:[{name:"Antigravity",type:"blue"},{name:"AI工具",type:"green"},{name:"下载指南",type:"blue"}],collection:"AI百科",relatedIds:[1,2,8,19],recommendationIds:[1,8,13,19],gallery:[M],markdownContent:`
...
`+i},{id:21,slug:"antigravity-v1-23-2-rules-troubleshooting",title:"Google Antigravity v1.23.2 项目规则不显示排查方案",image:W,date:"2026-05-08",author:"数维探索",views:"1,050",category:"教程",duration:"05:30",excerpt:"针对 Google Antigravity v1.23.2 版本中项目规则（Workspace Rules）无法加载或不显示的问题，提供了一套详尽的排查与修复方案，涵盖路径规范、UI 配置及已知 Bug 处理。",tags:[{name:"Antigravity",type:"blue"},{name:"故障排查",type:"green"},{name:"项目规则",type:"blue"}],collection:"AI百科",relatedIds:[1,5,20],recommendationIds:[5,18,19,20],gallery:[W],markdownContent:`
