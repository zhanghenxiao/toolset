...
`+l},{id:7,slug:"llm-open-source-panic",title:"AI开源大模型LLM的“闭源”恐慌: 一场虚惊还是行业趋势的开端?",image:A,date:"2026-04-07",author:"数维探索",views:"1,500",category:"新闻",duration:"06:30",excerpt:"近期，AI 社区中流传着一个令人不安的消息: 许多主流的开源大语言模型（LLM）可能会转向闭源。这个传闻并非空穴来风，本文将带你深入探究这一话题的来龙去脉。",tags:[{name:"AI趋势",type:"blue"},{name:"LLM",type:"blue"},{name:"开源",type:"green"}],collection:"AI百科",relatedIds:[8,12,14],recommendationIds:[12,14,15,2],gallery:[A],markdownContent:`
...
`+l},{id:8,slug:"claude-opus-4-6-antigravity",title:"Claude Opus 4.6 登陆 Antigravity: 是完整升级还是“残血版”? Pro 用户上手初体验",image:b,date:"2026-04-07",author:"数维探索",views:"1,000",category:"评测",duration:"08:00",excerpt:"备受期待的 Claude Opus 4.6 模型终于在 Google 的 AI IDE 平台 Antigravity 上线! 本视频将为你详细解析更新内容及1M上下文测试。",tags:[{name:"Claude",type:"blue"},{name:"Opus 4.6",type:"blue"},{name:"Antigravity",type:"green"}],collection:"AI百科",relatedIds:[1,9,10],recommendationIds:[1,10,12,14],gallery:[b],markdownContent:`
...
`+l},{id:9,slug:"mapbox-3d-map",title:"Mapbox GL JS 初始化 3D 建筑与地形教程",image:T,date:"2026-04-03",author:"数维探索",views:"1,100",category:"教程",duration:"12:30",excerpt:"学习如何使用 Mapbox GL JS 快速初始化一个包含 3D 建筑挤压（Fill-Extrusion）和数字高程模型（DEM）地形的交互式 3D 地图。",tags:[{name:"Mapbox",type:"blue"},{name:"3D地图",type:"blue"},{name:"WebGIS",type:"green"}],collection:"地图",relatedIds:[10,11,12],recommendationIds:[10,11,12,1],gallery:[T],markdownContent:`
mapbox初始化一个3D地图
...
`+l},{id:12,slug:"offline-leaflet-map",title:"Leaflet 离线地图下载与加载教程",image:dt,date:"2026-04-02",author:"数维探索",views:"1,200",category:"教程",duration:"10:00",excerpt:"本教程详细介绍了下载离线地图瓦片的两种方式（osm 和 MapTileDownloader），并提供了在 Leaflet 中加载离线地图的代码示例。",tags:[{name:"Leaflet",type:"blue"},{name:"地图",type:"blue"}],collection:"数维探索工具箱",relatedIds:[13,1,2],recommendationIds:[1,2,7,11],gallery:[],markdownContent:`
...
\`\`\`
`+l},{id:13,slug:"wireshark-windows-xp-guide",title:"Wireshark在Windows XP系统上的安装与使用指南",image:L,date:"2026-04-15",author:"数维探索",views:"1,200",category:"教程",duration:"10:00",excerpt:"Wireshark在Windows XP系统上运行需要特定的旧版本。本教程为你整理了最稳定的版本下载、WinPcap驱动安装及抓包注意事项。",tags:[{name:"Wireshark",type:"blue"},{name:"Windows XP",type:"blue"},{name:"抓包",type:"green"}],collection:"数维探索工具箱",relatedIds:[1,2,4],recommendationIds:[1,2,6,7],gallery:[L],markdownContent:`
...
`+l},{id:15,slug:"web-worker-vs-service-worker",title:"Web Worker vs Service Worker：多线程与离线缓存深度对比（含PWA实战）",image:ht,date:"2026-04-21",author:"数维探索",views:"1,000",category:"教程",duration:"12:00",excerpt:"深入对比 Web Worker 与 Service Worker 的核心区别：前者专注 CPU 密集型后台计算，后者充当网络代理实现离线缓存与 PWA。本文含完整代码示例与 PWA 实战项目结构。",tags:[{name:"Web Worker",type:"blue"},{name:"Service Worker",type:"blue"},{name:"PWA",type:"green"}],collection:"数维探索工具箱",relatedIds:[4,9,10],recommendationIds:[4,9,10,12],gallery:["/15/1.png"],markdownContent:` **Web Worker** 和 **Service Worker** 都是浏览器提供的 JavaScript 多线程技术，但它们的用途和工作方式有显著区别。
...
`+l},{id:16,slug:"karpathy-ai-coding-rules",title:"GitHub 6万星！Karpathy 的 AI 编码铁律：如何让 AI 乖乖写代码（附 Antigravity Knowledge 配置教程）",image:gt,date:"2026-04-22",author:"数维探索",views:"8,623",category:"教程",duration:"08:00",excerpt:"GitHub 趋势榜第一、Star 破6万的 AI 编码规范项目——基于 Karpathy 经验的4条铁律，配合 Antigravity Knowledge 全局配置，让 AI 写出更可控的代码。",tags:[{name:"AI工具",type:"blue"},{name:"Antigravity",type:"blue"},{name:"CLAUDE.md",type:"green"}],collection:"AI百科",relatedIds:[1,2,5],recommendationIds:[1,5,14,2],gallery:[],markdownContent:`这是目前 GitHub 前端/AI 圈最火的方向。因为大家都在用 AI 写代码，发现 AI 容易"放飞自我"（写得太复杂、乱改代码），所以大神们总结了一套**"如何让 AI 乖乖写代码"**的知识库。
...
`+l},{id:18,slug:"ai-knowledge-advanced-management",title:"AI 知识库实战：分类管理进阶与三大核心配置模板",image:vt,date:"2026-04-22",author:"数维探索",views:"5,102",category:"教程",duration:"07:00",excerpt:"将 AI 规则拆分为前端规范、接口文档和设计系统，附赠直接可用的高频 API 模板与 Tailwind UI/UX 原则，让 AI 秒变全能前端助手。",tags:[{name:"AI知识库",type:"blue"},{name:"前沿趋势",type:"green"}],collection:"AI百科",relatedIds:[17,16],recommendationIds:[17,16,5,14],gallery:[],markdownContent:`### 💡 进阶技巧：分类管理
...
- 层级
  ...
  - 模态框: \`z-50\`。
  - 提示条: \`z-50\`。
`+l},{id:19,slug:"global-skill-configuration-uipro",title:"全局技能配置实战：如何在所有项目中通用 UI-UX Pro Max",image:bt,date:"2026-04-22",author:"数维探索",views:"2,109",category:"教程",duration:"06:00",excerpt:"深入解析 Antigravity 技能架构的“全局库+项目引用”模式，两步实现在任意项目中全局调用 UI-UX Pro Max 技能，彻底解放生产力。",tags:[{name:"AI工具",type:"blue"},{name:"开发指南",type:"green"}],collection:"AI百科",relatedIds:[18,17],recommendationIds:[18,17,16,5],gallery:[],markdownContent:`要在**所有项目**中都使用 \`UI-UX Pro Max Skill\`，你需要理解 Antigravity 的技能架构是**"全局库 + 项目级引用"**的模式。
...
`+l},{id:20,slug:"google-antigravity-download-v1-23-2",title:"Google Antigravity 最新稳定版 v1.23.2 全平台免费下载 (官方正版)",image:j,date:"2026-05-08",author:"数维探索",views:"1,200",category:"教程",duration:"06:00",excerpt:"Google Antigravity 是 2025 年推出的 AI 原生 IDE，内置 Gemini 3.1 Pro，支持多模型切换与智能体自主开发。本文提供 v1.23.2 最新稳定版的各平台下载地址及安装配置指南。",tags:[{name:"Antigravity",type:"blue"},{name:"AI工具",type:"green"},{name:"下载指南",type:"blue"}],collection:"AI百科",relatedIds:[1,2,8,19],recommendationIds:[1,8,13,19],gallery:[j],markdownContent:`
...
`+l},{id:21,slug:"antigravity-v1-23-2-rules-troubleshooting",title:"Google Antigravity v1.23.2 项目规则不显示排查方案",image:W,date:"2026-05-08",author:"数维探索",views:"1,050",category:"教程",duration:"05:30",excerpt:"针对 Google Antigravity v1.23.2 版本中项目规则（Workspace Rules）无法加载或不显示的问题，提供了一套详尽的排查与修复方案，涵盖路径规范、UI 配置及已知 Bug 处理。",tags:[{name:"Antigravity",type:"blue"},{name:"故障排查",type:"green"},{name:"项目规则",type:"blue"}],collection:"AI百科",relatedIds:[1,5,20],recommendationIds:[5,18,19,20],gallery:[W],markdownContent:`
...
`+l}].reverse(),wt=["AI百科","2.5G网络","2026","AI","AI IDE","AI Studio","AI工具","AI学习","AI新闻","AI编程","AI趋势","acme.sh","Antigravity","Claude","DeepSeek","Gemini","Mac OS","Python","账号解封","Wireshark","Windows XP","抓包","开发指南","Web Worker","Service Worker","PWA","CLAUDE.md","Knowledge","Workflows","AI知识库","前沿趋势","下载指南","故障排查","项目规则"],yt=["AI百科","Docker百科","地图","数维探索工具箱","数维探索 行业研报"],kt=["视频","文章","教程","新闻","评测","展望"];const ft={name:"FilterSection",components:{DropdownFilter:O},props:{totalResults:{type:Number,default:0}},data(){return{allTags:wt,allCollections:yt,allTypes:kt,filters:{tags:[],collections:[],types:[],keyword:""}}},computed:{hasFilters(){return this.filters.tags.length>0||this.filters.collections.length>0||this.filters.types.length>0||this.filters.keyword!==""}},watch:{filters:{deep:!0,handler(s){this.$emit("filter-change",{...s})}}},methods:{handleSearch(){this.$emit("filter-change",{...this.filters})},clearFilters(){this.filters={tags:[],collections:[],types:[],keyword:""}}}};var Ct=function(){var t=this,e=t._self._c;return e("section",{staticClass:"filter-section"},[e("div",{staticClass:"container"},[e("div",{staticClass:"filter-card fade-in"},[e("div",{staticClass:"filter-grid"},[e("div",{staticClass:"filter-item"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("search.tagLabel")))]),e("DropdownFilter",{attrs:{placeholder:t.$t("search.tagPlaceholder"),options:t.allTags,showChips:!0},model:{value:t.filters.tags,callback:function(a){t.$set(t.filters,"tags",a)},expression:"filters.tags"}})],1),e("div",{staticClass:"filter-item"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("search.collectionLabel")))]),e("DropdownFilter",{attrs:{placeholder:t.$t("search.collectionPlaceholder"),options:t.allCollections},model:{value:t.filters.collections,callback:function(a){t.$set(t.filters,"collections",a)},expression:"filters.collections"}})],1),e("div",{staticClass:"filter-item"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("search.typeLabel")))]),e("DropdownFilter",{attrs:{placeholder:t.$t("search.typePlaceholder"),options:t.allTypes},model:{value:t.filters.types,callback:function(a){t.$set(t.filters,"types",a)},expression:"filters.types"}})],1),e("div",{staticClass:"filter-item search-box-wrapper"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("search.keywordLabel")))]),e("div",{staticClass:"search-box"},[e("input",{directives:[{name:"model",rawName:"v-model",value:t.filters.keyword,expression:"filters.keyword"}],staticClass:"search-input",attrs:{type:"text",placeholder:t.$t("search.keywordPlaceholder")},domProps:{value:t.filters.keyword},on:{keyup:function(a){return!a.type.indexOf("key")&&t._k(a.keyCode,"enter",13,a.key,"Enter")?null:t.handleSearch.apply(null,arguments)},input:function(a){a.target.composing||t.$set(t.filters,"keyword",a.target.value)}}}),e("button",{staticClass:"search-btn",on:{click:t.handleSearch}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"}})])])])])]),e("div",{staticClass:"results-bar"},[e("div",{staticClass:"results-count",domProps:{innerHTML:t._s(t.$t("search.resultsCount",{total:`<span class='highlight'>${t.totalResults}</span>`}))}}),t.hasFilters?e("button",{staticClass:"clear-btn",on:{click:t.clearFilters}},[t._v(t._s(t.$t("search.clear")))]):t._e()])])])])},xt=[],_t=d(ft,Ct,xt,!1,null,"3a2c80c9",null,null);const Ut=_t.exports;const At={name:"ContentCard",props:{item:{type:Object,required:!0}}};var It=function(){var t=this,e=t._self._c;return e("div",{staticClass:"content-card fade-in"},[e("div",{staticClass:"card-image"},[e("img",{attrs:{src:t.item.image,alt:t.item.title}}),e("div",{staticClass:"image-overlay"})]),e("div",{staticClass:"card-body"},[e("h3",{staticClass:"card-title"},[t._v(t._s(t.item.title))]),e("div",{staticClass:"card-meta"},[e("div",{staticClass:"meta-item"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"14",height:"14"}},[e("path",{attrs:{fill:"currentColor",d:"M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2z"}})]),e("span",[t._v(t._s(t.item.date))])]),e("div",{staticClass:"meta-item"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"14",height:"14"}},[e("path",{attrs:{fill:"currentColor",d:"M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"}})]),e("span",[t._v(t._s(t.item.author))])])]),e("p",{staticClass:"card-excerpt"},[t._v(t._s(t.item.excerpt))]),e("div",{staticClass:"card-tags"},t._l(t.item.tags,function(a){return e("span",{key:a,staticClass:"tag",class:"tag-"+a.type},[t._v(t._s(a.name))])}),0)])])},St=[],Tt=d(At,It,St,!1,null,"3bba609e",null,null);const z=Tt.exports;const qt={name:"Pagination",props:{total:{type:Number,required:!0},current:{type:Number,required:!0},totalItems:{type:Number,required:!0},showInfo:{type:Boolean,default:!0}},computed:{displayedPages(){const s=[];for(let t=1;t<=this.total;t++)s.push(t);return s}},methods:{changePage(s){s>=1&&s<=this.total&&this.$emit("change",s)}}};var Pt=function(){var t=this,e=t._self._c;return e("div",{staticClass:"pagination-container fade-in"},[e("div",{staticClass:"pagination"},[e("button",{staticClass:"page-btn prev",attrs:{disabled:t.current===1},on:{click:function(a){return t.changePage(t.current-1)}}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"}})])]),e("div",{staticClass:"page-numbers"},t._l(t.displayedPages,function(a){return e("button",{key:a,staticClass:"page-number",class:{active:a===t.current},on:{click:function(r){return t.changePage(a)}}},[t._v(" "+t._s(a)+" ")])}),0),e("button",{staticClass:"page-btn next",attrs:{disabled:t.current===t.total},on:{click:function(a){return t.changePage(t.current+1)}}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"}})])])]),t.showInfo?e("div",{staticClass:"pagination-info"},[t._v(" "+t._s(t.$t("pagination.info",{total:t.totalItems,current:t.current,pages:t.total}))+" ")]):t._e()])},Lt=[],Mt=d(qt,Pt,Lt,!1,null,"a23eac68",null,null);const G=Mt.exports;const jt={name:"SiteFooter",data(){return{showScrollTop:!1}},mounted(){window.addEventListener("scroll",this.handleScroll)},beforeDestroy(){window.removeEventListener("scroll",this.handleScroll)},methods:{handleScroll(){this.showScrollTop=window.pageYOffset>300},scrollToTop(){window.scrollTo({top:0,behavior:"smooth"})}}};var Wt=function(){var t=this,e=t._self._c;return e("footer",{staticClass:"site-footer"},[e("div",{staticClass:"footer-bottom"},[e("div",{staticClass:"container"},[e("p",[t._v("© 2026 内容创作展示网站 toolset.site 保留所有权利 | "),e("router-link",{attrs:{to:"/about"}},[t._v("关于我们")]),t._v(" | "),e("router-link",{attrs:{to:"/privacy-policy"}},[t._v("隐私政策")])],1)])]),e("div",{staticClass:"floating-actions",class:{show:t.showScrollTop}},[e("button",{staticClass:"float-btn to-top",attrs:{title:"回到顶部"},on:{click:t.scrollToTop}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"24",height:"24"}},[e("path",{attrs:{fill:"currentColor",d:"M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z"}})])])])])},Ft=[],$t=d(jt,Wt,Ft,!1,null,"5bb84cef",null,null);const k=$t.exports;const Et={name:"Home",components:{SiteHeader:y,FilterSection:Ut,ContentCard:z,Pagination:G,SiteFooter:k},data(){return{contentItems:v,filters:{tags:[],collections:[],types:[],keyword:""},currentPage:1,pageSize:8}},computed:{filteredItems(){return this.contentItems.filter(s=>{const t=!this.filters.keyword||s.title.toLowerCase().includes(this.filters.keyword.toLowerCase())||s.excerpt.toLowerCase().includes(this.filters.keyword.toLowerCase()),e=this.filters.tags.length===0||s.tags.some(o=>this.filters.tags.includes(o.name)),a=this.filters.collections.length===0||this.filters.collections.includes(s.collection),r=this.filters.types.length===0||this.filters.types.includes(s.category);return t&&e&&a&&r})},totalPages(){return Math.ceil(this.filteredItems.length/this.pageSize)||1},paginatedItems(){const s=(this.currentPage-1)*this.pageSize,t=s+this.pageSize;return this.filteredItems.slice(s,t)}},methods:{handleFilterChange(s){this.filters={...s},this.currentPage=1},handlePageChange(s){this.currentPage=s,window.scrollTo({top:0,behavior:"smooth"})},goToDetail(s){const t=this.contentItems.find(e=>e.id===s);t&&this.$router.push(`/detail/${t.slug}`)}}};var Dt=function(){var t=this,e=t._self._c;return e("div",{staticClass:"home-page"},[e("SiteHeader"),e("main",[e("FilterSection",{attrs:{totalResults:t.filteredItems.length},on:{"filter-change":t.handleFilterChange}}),e("section",{staticClass:"container py-40"},[t.paginatedItems.length>0?e("div",[e("div",{staticClass:"grid fade-in"},t._l(t.paginatedItems,function(a){return e("ContentCard",{key:a.id,attrs:{item:a},nativeOn:{click:function(r){return t.goToDetail(a.id)}}})}),1),e("Pagination",{attrs:{total:t.totalPages,current:t.currentPage,totalItems:t.filteredItems.length},on:{change:t.handlePageChange}})],1):e("div",{staticClass:"no-results fade-in"},[e("div",{staticClass:"no-results-content"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"64",height:"64"}},[e("path",{attrs:{fill:"currentColor",d:"M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"}})]),e("p",[t._v(t._s(t.$t("search.noResults")))])])])])],1),e("SiteFooter")],1)},Ot=[],zt=d(Et,Dt,Ot,!1,null,"c1f16c41",null,null);const Gt=zt.exports;const Bt={name:"RelatedContent",props:{items:{type:Array,required:!0}},methods:{handleItemClick(s){this.$emit("select",s)}}};var Rt=function(){var t=this,e=t._self._c;return e("aside",{staticClass:"sidebar"},[e("div",{staticClass:"sidebar-header"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"18",height:"18"}},[e("path",{attrs:{fill:"var(--primary-color)",d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-4h2v4zm0-6h-2V7h2v4z"}})]),e("span",[t._v("关联内容")])]),e("div",{staticClass:"related-list"},t._l(t.items,function(a){return e("div",{key:a.id,staticClass:"related-item",on:{click:function(r){return t.handleItemClick(a.id)}}},[e("div",{staticClass:"related-thumb"},[e("img",{attrs:{src:a.image,alt:"Thumbnail"}})]),e("div",{staticClass:"related-info"},[e("h4",{staticClass:"related-title"},[t._v(t._s(a.title))]),e("div",{staticClass:"related-meta"},[e("span",[t._v("时长: "+t._s(a.duration))]),e("span",{staticClass:"author"},[t._v("| "+t._s(a.author))])]),e("div",{staticClass:"related-tags"},t._l(a.tags.slice(0,2),function(r){return e("span",{key:r.name,staticClass:"mini-tag"},[t._v(t._s(r.name))])}),0)])])}),0)])},Vt=[],Nt=d(Bt,Rt,Vt,!1,null,"e7c5a0d7",null,null);const Ht=Nt.exports;const B=new Z({html:!0,highlight:function(s,t){if(t&&C.getLanguage(t))try{return`<pre class="hljs"><code>${C.highlight(s,{language:t}).value}</code><button class="copy-btn" data-clipboard-text="${encodeURIComponent(s)}">Copy</button></pre>`}catch{}return`<pre class="hljs"><code>${B.utils.escapeHtml(s)}</code><button class="copy-btn" data-clipboard-text="${encodeURIComponent(s)}">Copy</button></pre>`}}),Zt={name:"MarkdownRenderer",props:{content:{type:String,default:""}},computed:{previewHtml(){return B.render(this.content)}},mounted(){this.$el.addEventListener("click",this.handleCopy),this.addLazyLoading()},beforeDestroy(){this.$el.removeEventListener("click",this.handleCopy)},watch:{content(){this.$nextTick(()=>{this.addLazyLoading()})}},methods:{handleCopy(s){if(s.target.classList.contains("copy-btn")){const t=decodeURIComponent(s.target.getAttribute("data-clipboard-text"));navigator.clipboard.writeText(t).then(()=>{const e=s.target.innerText;s.target.innerText="Copied!",setTimeout(()=>{s.target.innerText=e},2e3)})}},addLazyLoading(){this.$el.querySelectorAll("img").forEach(t=>{t.setAttribute("loading","lazy")})}}};var Jt=function(){var t=this,e=t._self._c;return e("div",{staticClass:"markdown-body",domProps:{innerHTML:t._s(t.previewHtml)}})},Kt=[],Qt=d(Zt,Jt,Kt,!1,null,null,null,null);const Xt=Qt.exports;const Yt={name:"ContentDetail",components:{SiteHeader:y,SiteFooter:k,ContentCard:z,RelatedContent:Ht,MarkdownRenderer:Xt},props:{slug:{type:String,required:!0}},data(){return{item:null,relatedItems:[],recommendationItems:[]}},watch:{slug:{handler:"loadItem",immediate:!0}},methods:{loadItem(){if(this.item=v.find(s=>s.slug===this.slug),this.item){this.relatedItems=v.filter(t=>this.item.relatedIds.includes(t.id));const s=this.item.recommendationIds;this.recommendationItems=v.filter(t=>s.includes(t.id)).slice(0,4)}},goToDetail(s){const t=v.find(e=>e.id===s);t&&t.slug!==this.slug&&this.$router.push(`/detail/${t.slug}`)}}};var te=function(){var t=this,e=t._self._c;return e("div",{staticClass:"content-detail-page"},[e("SiteHeader"),e("main",{staticClass:"container detail-container fade-in"},[t.item?e("div",{staticClass:"detail-layout"},[e("div",{staticClass:"main-content"},[e("div",{staticClass:"video-player"},[e("img",{attrs:{src:t.item.image,alt:"Thumbnail"}}),e("div",{staticClass:"player-overlay"},[e("div",{staticClass:"play-btn-large"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"48",height:"48"}},[e("path",{attrs:{fill:"white",d:"M8 5v14l11-7z"}})])])])]),e("div",{staticClass:"content-info"},[e("h1",{staticClass:"detail-title"},[t._v(t._s(t.item.title))]),e("div",{staticClass:"meta-data-section"},[e("div",{staticClass:"full-meta"},[e("div",{staticClass:"meta-row"},[e("span",{staticClass:"meta-label"},[t._v("发布时间:")]),e("span",{staticClass:"meta-value"},[t._v(t._s(t.item.date))]),e("span",{staticClass:"meta-label ml-20"},[t._v("作者:")]),e("span",{staticClass:"meta-value"},[t._v(t._s(t.item.author))])]),e("div",{staticClass:"meta-row"},[e("span",{staticClass:"meta-label"},[t._v("浏览数:")]),e("span",{staticClass:"meta-value"},[t._v(t._s(t.item.views)+" 次")]),e("span",{staticClass:"meta-label ml-20"},[t._v("分类:")]),e("span",{staticClass:"meta-value"},[t._v(t._s(t.item.category))])])]),e("div",{staticClass:"interaction-bar"},[e("div",{staticClass:"stats-group"},[e("button",{staticClass:"stat-btn"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"18",height:"18"}},[e("path",{attrs:{fill:"currentColor",d:"M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-2z"}})]),e("span",[t._v("0")])]),e("button",{staticClass:"stat-btn"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"18",height:"18"}},[e("path",{attrs:{fill:"currentColor",d:"M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"}})]),e("span",[t._v("0")])]),e("button",{staticClass:"stat-btn"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"18",height:"18"}},[e("path",{attrs:{fill:"currentColor",d:"M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"}})]),e("span",[t._v("0")])])])])]),e("div",{staticClass:"detail-tags"},t._l(t.item.tags,function(a){return e("span",{key:a.name,staticClass:"tag",class:"tag-"+a.type},[t._v(t._s(a.name))])}),0),e("section",{staticClass:"markdown-section"},[e("div",{staticClass:"section-header"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"}})]),e("span",[t._v("支持内容")])]),e("div",{staticClass:"markdown-content-card"},[e("MarkdownRenderer",{attrs:{content:t.item.markdownContent}})],1)])])]),e("RelatedContent",{attrs:{items:t.relatedItems},on:{select:t.goToDetail}})],1):e("div",{staticClass:"not-found"},[t._v(" Loading... ")]),e("section",{staticClass:"recommendations"},[e("div",{staticClass:"section-header"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.13-14.71a.5.5 0 0 0-.58.12l-3 4a.5.5 0 0 0 .4.8h1.55l-2.07 4.14a.5.5 0 0 0 .45.72h2l-2.22 4.44a.5.5 0 0 0 .89.44l7-14a.5.5 0 0 0-.42-.66z"}})]),e("span",[t._v("相关推荐")])]),e("div",{staticClass:"grid"},t._l(t.recommendationItems,function(a){return e("ContentCard",{key:a.id,attrs:{item:a},nativeOn:{click:function(r){return t.goToDetail(a.id)}}})}),1)])]),e("SiteFooter")],1)},ee=[],se=d(Yt,te,ee,!1,null,"f37a6643",null,null);const ae=se.exports,F=[{category:"AI 热门应用",icon:"🔥",tools:[{name:"股票趋势分析",desc:"基于历史数据和AI算法分析股票价格走势",url:"https://www.tradingview.com",icon:"https://api.iowen.cn/favicon/tradingview.com.png"},{name:"市场情绪分析",desc:"分析新闻、社交媒体等数据，评估市场情绪",url:"https://www.sentimentinvestor.com",icon:"https://api.iowen.cn/favicon/sentimentinvestor.com.png"},{name:"投资组合优化",desc:"根据风险偏好和目标收益优化投资组合",url:"https://www.portfoliooptimizer.io",icon:"https://api.iowen.cn/favicon/portfoliooptimizer.io.png"},{name:"股票预测模型",desc:"使用机器学习算法预测股票未来价格",url:"https://www.stockprediction.ai",icon:"https://api.iowen.cn/favicon/stockprediction.ai.png"}]},{category:"AI 对话",icon:"💬",tools:[{name:"Jasper Chat",desc:"Jasper针对内容创作者出品的AI聊天工具",url:"https://www.jasper.ai",icon:"https://api.iowen.cn/favicon/jasper.ai.png"},{name:"IngestAI",desc:"一种帮助人们将他们的知识库转化为聊天机器人的工具",url:"https://ingestai.io",icon:"https://api.iowen.cn/favicon/ingestai.io.png"},{name:"Andi",desc:"人工智能搜索——Andi机器人",url:"https://andi.com",icon:"https://api.iowen.cn/favicon/andi.com.png"},{name:"AI对话【问答宝】",desc:"【问答宝】ChatGPT，目前这个工具很受欢迎",url:"https://www.askbob.ai",icon:"https://api.iowen.cn/favicon/askbob.ai.png"},{name:"ChatGPT",desc:"open AI",url:"https://chat.openai.com",icon:"https://api.iowen.cn/favicon/openai.com.png"},{name:"文心一言",desc:"文心一言",url:"https://yiyan.baidu.com",icon:"https://api.iowen.cn/favicon/baidu.com.png"},{name:"CatGPT",desc:"完全免费",url:"https://catgpt.app",icon:"https://api.iowen.cn/favicon/catgpt.app.png"},{name:"趣学ChatGPT",desc:"免费链，国内可用",url:"https://chatgpt.kuxueai.com",icon:"https://api.iowen.cn/favicon/kuxueai.com.png"},{name:"ChatGPT3.5",desc:"chat3.5，免费链，国内可用",url:"https://chatgpt35.com",icon:"https://api.iowen.cn/favicon/chatgpt35.com.png"}]},{category:"AI 写作",icon:"✍️",tools:[{name:"AI帮个忙",desc:"多功能AI小帮手",url:"https://aibang.ai",icon:"https://api.iowen.cn/favicon/aibang.ai.png"},{name:"Glasp",desc:"高亮网页，全文摘要，内容概要",url:"https://glasp.co",icon:"https://api.iowen.cn/favicon/glasp.co.png"},{name:"Fireflies",desc:"为会议生成成绩单和智能摘要",url:"https://fireflies.ai",icon:"https://api.iowen.cn/favicon/fireflies.ai.png"},{name:"Yaara",desc:"几分钟内创建高质量、引人入胜的内容",url:"https://yaara.ai",icon:"https://api.iowen.cn/favicon/yaara.ai.png"},{name:"Hoppy Copy",desc:"编写长篇内容，将混乱的笔记转换成清晰的文章",url:"https://hoppycopy.co",icon:"https://api.iowen.cn/favicon/hoppycopy.co.png"}]},{category:"AI 编程",icon:"💻",tools:[{name:"GitHub Copilot",desc:"AI 编程助手",url:"https://github.com/features/copilot",icon:"https://api.iowen.cn/favicon/github.com.png"},{name:"Cursor",desc:"基于 AI 的代码编辑器",url:"https://cursor.sh",icon:"https://api.iowen.cn/favicon/cursor.sh.png"}]},{category:"影音编辑",icon:"🎬",tools:[{name:"Easy-Peasy",desc:"包含AI生成文案、图片、智能对话等多种功能",url:"https://easy-peasy.ai",icon:"https://api.iowen.cn/favicon/easy-peasy.ai.png"},{name:"Papercup",desc:"下一代人工智能配音服务，使视频内容更具吸引力",url:"https://papercup.com",icon:"https://api.iowen.cn/favicon/papercup.com.png"},{name:"Mubert",desc:"面向内容创作者、品牌和开发者的AI音乐生成平台",url:"https://mubert.com",icon:"https://api.iowen.cn/favicon/mubert.com.png"},{name:"Murf",desc:"20种语言的AI语音生成器，120多个语音选项",url:"https://murf.ai",icon:"https://api.iowen.cn/favicon/murf.ai.png"}]}];let h=null;const re={name:"VideoCutter",data(){return{videoSrc:"",videoFile:null,fileName:"video.mp4",startTime:0,endTime:0,duration:0,currentTime:0,isProcessing:!1,progress:0,loadingStatus:"idle"}},computed:{loadingStatusText(){return{"loading-engine":this.isZh?"正在加载引擎...":"Loading Engine...",uploading:this.isZh?"正在读取文件...":"Reading File...",processing:this.isZh?"正在处理...":"Processing...",saving:this.isZh?"正在保存...":"Saving..."}[this.loadingStatus]||""},isZh(){return this.$i18n.locale==="zh"},cutDuration(){return Math.max(0,this.endTime-this.startTime)},supportsWasm(){return typeof WebAssembly<"u"},ffmpegCommand(){const s=`cut_${this.fileName}`;return`ffmpeg -i "${this.fileName}" -ss ${this.startTime.toFixed(2)} -t ${this.cutDuration.toFixed(2)} -c copy "${s}"`}},methods:{handleFileChange(s){const t=s.target.files[0];t&&(this.videoFile=t,this.fileName=t.name,this.videoSrc=URL.createObjectURL(t))},onVideoLoaded(){const s=this.$refs.videoPlayer;this.duration=s.duration,this.endTime=s.duration},onTimeUpdate(){this.currentTime=this.$refs.videoPlayer.currentTime},updatePreview(s){const t=this.$refs.videoPlayer;s==="start"?t.currentTime=this.startTime:t.currentTime=this.endTime},setCurrentTime(s){s==="start"?this.startTime=Number(this.currentTime.toFixed(2)):this.endTime=Number(this.currentTime.toFixed(2))},async loadFFmpeg(){if(!(h&&h.isLoaded())){console.log("[FFmpeg v0.11] Initializing single-threaded engine..."),this.loadingStatus="loading-engine",h=x.createFFmpeg({corePath:"/ffmpeg-core-st.js",log:!0,progress:({ratio:s})=>{this.progress=Math.round(s*100)}});try{console.log("[FFmpeg v0.11] Calling ffmpeg.load()..."),await h.load(),console.log("[FFmpeg v0.11] Engine loaded successfully!")}catch(s){console.error("[FFmpeg v0.11] Load failed:",s);const t=(this.isZh?"加载 FFmpeg 引擎失败：":"Failed to load FFmpeg: ")+s.message;throw new Error(t)}}},async cutAndDownload(){if(this.videoFile)try{this.isProcessing=!0,this.progress=0,await this.loadFFmpeg(),console.log("Starting cut process..."),this.loadingStatus="uploading";const s="input_"+this.fileName.replace(/[^a-zA-Z0-9.]/g,"_"),t=`output_${Date.now()}.mp4`;console.log(`Writing ${this.fileName} to virtual FS...`),h.FS("writeFile",s,await x.fetchFile(this.videoFile)),console.log("File written"),this.loadingStatus="processing";const e=["-ss",this.startTime.toFixed(2),"-i",s,"-t",this.cutDuration.toFixed(2),"-c","copy",t];console.log(`Executing: ffmpeg ${e.join(" ")}`);try{await h.run(...e),console.log("FFmpeg run completed")}catch(p){throw console.error("FFmpeg run error:",p),new Error(this.isZh?"FFmpeg 执行失败，请检查视频格式。":"FFmpeg execution failed. Check video format.")}this.loadingStatus="saving",console.log(`Reading output: ${t}`);let a;try{a=h.FS("readFile",t)}catch(p){throw console.error("Read error:",p),new Error(this.isZh?"读取输出文件失败。":"Failed to read output file.")}const r=new Blob([a.buffer],{type:"video/mp4"}),o=URL.createObjectURL(r),i=document.createElement("a");i.href=o,i.download=`cut_${this.fileName}`,i.click(),URL.revokeObjectURL(o);try{h.FS("unlink",s),h.FS("unlink",t)}catch(p){console.warn("Cleanup error:",p)}this.isProcessing=!1,this.loadingStatus="idle",alert(this.isZh?"剪切成功！":"Video cut successfully!")}catch(s){console.error("Processing error:",s),alert((this.isZh?"处理出错：":"Error: ")+s.message),this.isProcessing=!1,this.loadingStatus="idle"}},reset(){this.videoSrc="",this.videoFile=null,this.startTime=0,this.endTime=0,this.duration=0},copyCommand(){navigator.clipboard.writeText(this.ffmpegCommand).then(()=>{alert(this.isZh?"命令已复制":"Command copied")})}}};var oe=function(){var t=this,e=t._self._c;return e("div",{staticClass:"video-cutter-tool"},[e("div",{staticClass:"tool-header"},[e("h3",[t._v(t._s(t.isZh?"视频剪切工具":"Video Cutter"))]),e("p",[t._v(t._s(t.isZh?"通过可视化界面轻松剪切视频并生成 FFmpeg 命令。":"Easily cut videos and generate FFmpeg commands with a visual interface."))])]),t.supportsWasm?t._e():e("div",{staticClass:"warning-banner"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M12 2L1 21h22L12 2zm0 3.45L19.53 19H4.47L12 5.45zM11 16h2v2h-2v-2zm0-6h2v4h-2v-4z"}})]),e("span",[t._v(t._s(t.isZh?"您的浏览器尚未启用共享内存支持。请确保已重启开发服务器（npm run dev），并使用最新版 Chrome/Edge 访问。":"SharedArrayBuffer is not enabled. Please restart dev server (npm run dev) and use latest Chrome/Edge."))])]),e("div",{staticClass:"tool-container"},[t.videoSrc?e("div",{staticClass:"editor-layout"},[e("div",{staticClass:"preview-section"},[e("video",{ref:"videoPlayer",attrs:{src:t.videoSrc,controls:""},on:{loadedmetadata:t.onVideoLoaded,timeupdate:t.onTimeUpdate}}),e("div",{staticClass:"range-controls"},[e("div",{staticClass:"range-inputs"},[e("div",{staticClass:"input-group"},[e("label",[t._v(t._s(t.isZh?"开始时间 (秒)":"Start Time (s)"))]),e("input",{directives:[{name:"model",rawName:"v-model.number",value:t.startTime,expression:"startTime",modifiers:{number:!0}}],attrs:{type:"number",min:"0",max:t.endTime,step:"0.1"},domProps:{value:t.startTime},on:{input:[function(a){a.target.composing||(t.startTime=t._n(a.target.value))},function(a){return t.updatePreview("start")}],blur:function(a){return t.$forceUpdate()}}})]),e("div",{staticClass:"input-group"},[e("label",[t._v(t._s(t.isZh?"结束时间 (秒)":"End Time (s)"))]),e("input",{directives:[{name:"model",rawName:"v-model.number",value:t.endTime,expression:"endTime",modifiers:{number:!0}}],attrs:{type:"number",min:t.startTime,max:t.duration,step:"0.1"},domProps:{value:t.endTime},on:{input:[function(a){a.target.composing||(t.endTime=t._n(a.target.value))},function(a){return t.updatePreview("end")}],blur:function(a){return t.$forceUpdate()}}})]),e("div",{staticClass:"input-group duration-info"},[e("label",[t._v(t._s(t.isZh?"持续时间":"Duration"))]),e("div",{staticClass:"value"},[t._v(t._s(t.cutDuration.toFixed(2))+"s")])])]),e("div",{staticClass:"quick-actions"},[e("button",{staticClass:"btn-outline",on:{click:function(a){return t.setCurrentTime("start")}}},[t._v(t._s(t.isZh?"设为开始点":"Set as Start"))]),e("button",{staticClass:"btn-outline",on:{click:function(a){return t.setCurrentTime("end")}}},[t._v(t._s(t.isZh?"设为结束点":"Set as End"))]),e("button",{staticClass:"btn-primary",attrs:{disabled:t.isProcessing||!t.supportsWasm||!t.videoFile},on:{click:t.cutAndDownload}},[t.isProcessing?e("span",[t.loadingStatus==="processing"?[t._v(t._s(t.isZh?"处理中 "+t.progress+"%":"Processing "+t.progress+"%"))]:[t._v(t._s(t.loadingStatusText))]],2):e("span",[t._v(t._s(t.isZh?"开始剪切并下载":"Start Cut & Download"))])]),e("button",{staticClass:"btn-danger",attrs:{disabled:t.isProcessing},on:{click:t.reset}},[t._v(t._s(t.isZh?"清除视频":"Clear Video"))])])])]),e("div",{staticClass:"command-section"},[e("h4",[t._v(t._s(t.isZh?"生成的 FFmpeg 命令":"Generated FFmpeg Command"))]),e("div",{staticClass:"command-box"},[e("code",[t._v(t._s(t.ffmpegCommand))]),e("button",{staticClass:"btn-copy",on:{click:t.copyCommand}},[t._v(" "+t._s(t.isZh?"复制命令":"Copy Command")+" ")])]),e("div",{staticClass:"tips"},[e("p",[e("strong",[t._v(t._s(t.isZh?"提示：":"Tip:"))])]),e("ul",[e("li",[t._v(t._s(t.isZh?"点击“开始剪切并下载”将直接在浏览器中处理，无需上传服务器。":'Clicking "Start Cut & Download" will process directly in your browser.'))]),e("li",[t._v(t._s(t.isZh?"首次使用会加载约 30MB 的处理引擎，请耐心等待。":"The processing engine (~30MB) will be loaded on first use."))]),e("li",[t._v(t._s(t.isZh?"处理大视频可能需要较多内存和 CPU。":"Processing large videos may require significant memory and CPU."))])])])])]):e("div",{staticClass:"upload-zone",on:{click:function(a){return t.$refs.fileInput.click()}}},[e("div",{staticClass:"upload-icon"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"48",height:"48"}},[e("path",{attrs:{fill:"currentColor",d:"M18 15v3H6v-3H4v3c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-3h-2zM7 9l1.41 1.41L11 7.83V16h2V7.83l2.59 2.58L17 9l-5-5-5 5z"}})])]),e("p",[t._v(t._s(t.isZh?"点击或拖拽视频文件到此处进行预览":"Click or drag video file here to preview"))]),e("input",{ref:"fileInput",attrs:{type:"file",accept:"video/*",hidden:""},on:{change:t.handleFileChange}})])])])},ie=[],ne=d(re,oe,ie,!1,null,"2e00e448",null,null);const le=ne.exports;const ce={name:"ToolStation",components:{VideoCutter:le},data(){return{currentTs:Math.floor(Date.now()/1e3),timer:null,inputTs:"",inputDate:"",convertResult:"",aiToolsGroups:F,activeCategory:F[0].category}},computed:{isZh(){return this.$i18n.locale==="zh"},currentGroup(){return this.aiToolsGroups.find(s=>s.category===this.activeCategory)},description(){return this.isZh?"快速在 Unix 时间戳和人类可读时间之间进行准确转换。":"Quickly convert between Unix timestamps and human-readable time."}},mounted(){this.startTimer()},beforeDestroy(){this.stopTimer()},methods:{startTimer(){this.timer=setInterval(()=>{this.currentTs=Math.floor(Date.now()/1e3)},1e3)},stopTimer(){this.timer&&(clearInterval(this.timer),this.timer=null)},toggleTimer(){this.timer?this.stopTimer():this.startTimer()},copy(s){navigator.clipboard.writeText(String(s)).then(()=>{const t=document.createElement("div");t.className="toast-msg",t.textContent=this.isZh?"✓ 已复制":"✓ Copied",document.body.appendChild(t),setTimeout(()=>t.remove(),2e3)})},toTime(){if(!this.inputTs)return;let s=parseInt(this.inputTs);this.inputTs.length===10&&(s*=1e3);const t=new Date(s);this.convertResult=t.toLocaleString()},toTs(){if(!this.inputDate)return;const s=new Date(this.inputDate);if(isNaN(s.getTime())){this.convertResult=this.isZh?"无效的日期格式":"Invalid date format";return}this.convertResult=Math.floor(s.getTime()/1e3).toString()},handleImgError(s){s.target.src="/favicon-default.png"}}};var de=function(){var t=this,e=t._self._c;return e("div",{staticClass:"tool-station-page"},[e("div",{staticClass:"container"},[e("div",{staticClass:"page-hero"},[e("div",{staticClass:"hero-icon"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"28",height:"28",fill:"none",stroke:"currentColor","stroke-width":"1.8"}},[e("path",{attrs:{"stroke-linecap":"round","stroke-linejoin":"round",d:"M14.25 9.75 16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25Z"}})])]),e("div",[e("h1",{staticClass:"hero-title"},[t._v(t._s(t.isZh?"工具站":"Tool Station"))]),e("p",{staticClass:"hero-sub"},[t._v(t._s(t.isZh?"开发者效率工具集合":"Developer Productivity Toolkit"))])])]),e("section",{staticClass:"tool-section"},[e("div",{staticClass:"section-header"},[e("div",{staticClass:"section-title-group"},[e("div",{staticClass:"section-icon"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2"}},[e("circle",{attrs:{cx:"12",cy:"12",r:"9"}}),e("path",{attrs:{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 7v5l3 3"}})])]),e("h2",[t._v(t._s(t.isZh?"时间戳转换工具":"Timestamp Converter"))])]),e("p",{staticClass:"section-desc"},[t._v(t._s(t.description))])]),e("div",{staticClass:"converter-body"},[e("div",{staticClass:"live-ts-bar"},[e("div",{staticClass:"live-badge"},[e("span",{staticClass:"live-dot"}),t._v(" "+t._s((t.isZh,"LIVE"))+" ")]),e("div",{staticClass:"live-ts-value"},[t._v(t._s(t.currentTs))]),e("div",{staticClass:"live-actions"},[e("button",{staticClass:"btn-icon",attrs:{title:t.timer?t.isZh?"暂停":"Pause":t.isZh?"继续":"Resume"},on:{click:t.toggleTimer}},[t.timer?e("svg",{attrs:{viewBox:"0 0 24 24",width:"16",height:"16",fill:"currentColor"}},[e("path",{attrs:{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"}})]):e("svg",{attrs:{viewBox:"0 0 24 24",width:"16",height:"16",fill:"currentColor"}},[e("path",{attrs:{d:"M8 5v14l11-7z"}})])]),e("button",{staticClass:"btn-copy",on:{click:function(a){return t.copy(t.currentTs)}}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"15",height:"15",fill:"none",stroke:"currentColor","stroke-width":"2"}},[e("rect",{attrs:{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}}),e("path",{attrs:{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"}})]),t._v(" "+t._s(t.isZh?"复制":"Copy")+" ")])])]),e("div",{staticClass:"converter-grid"},[e("div",{staticClass:"input-group"},[e("label",{staticClass:"input-label"},[e("span",{staticClass:"label-tag"},[t._v("Unix")]),t._v(" "+t._s(t.isZh?"时间戳 (s 或 ms)":"Timestamp (s or ms)")+" ")]),e("div",{staticClass:"input-row"},[e("input",{directives:[{name:"model",rawName:"v-model",value:t.inputTs,expression:"inputTs"}],staticClass:"code-input",attrs:{type:"text",placeholder:"1712110000"},domProps:{value:t.inputTs},on:{input:function(a){a.target.composing||(t.inputTs=a.target.value)}}}),e("button",{staticClass:"btn-primary",on:{click:t.toTime}},[t._v(" "+t._s(t.isZh?"→ 日期":"→ Date")+" ")])])]),e("div",{staticClass:"input-group"},[e("label",{staticClass:"input-label"},[e("span",{staticClass:"label-tag"},[t._v("ISO")]),t._v(" "+t._s(t.isZh?"日期时间":"Datetime")+" ")]),e("div",{staticClass:"input-row"},[e("input",{directives:[{name:"model",rawName:"v-model",value:t.inputDate,expression:"inputDate"}],staticClass:"code-input",attrs:{type:"text",placeholder:"2024-04-03 10:00:00"},domProps:{value:t.inputDate},on:{input:function(a){a.target.composing||(t.inputDate=a.target.value)}}}),e("button",{staticClass:"btn-primary",on:{click:t.toTs}},[t._v(" "+t._s(t.isZh?"→ 戳":"→ Ts")+" ")])])])]),e("transition",{attrs:{name:"slide-fade"}},[t.convertResult?e("div",{staticClass:"result-box"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"16",height:"16",fill:"none",stroke:"currentColor","stroke-width":"2"}},[e("path",{attrs:{"stroke-linecap":"round","stroke-linejoin":"round",d:"m4.5 12.75 6 6 9-13.5"}})]),e("span",{staticClass:"result-label"},[t._v(t._s(t.isZh?"结果":"Result"))]),e("span",{staticClass:"result-value"},[t._v(t._s(t.convertResult))]),e("button",{staticClass:"btn-copy-sm",on:{click:function(a){return t.copy(t.convertResult)}}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"13",height:"13",fill:"none",stroke:"currentColor","stroke-width":"2"}},[e("rect",{attrs:{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}}),e("path",{attrs:{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"}})])])]):t._e()])],1)]),e("section",{staticClass:"tool-section video-cutter-section"},[e("VideoCutter")],1)])])},pe=[],ue=d(ce,de,pe,!1,null,"03c96818",null,null);const he=ue.exports,ge="/assets/wudao-154-d931e249.jpg",me="/assets/book-1-9cec7e12.jpg",ve="/assets/book-2-db705184.jpg",be="/assets/book-3-98ff25ae.jpg",we="/assets/book-4-e14fec56.jpg",ye="/assets/book-5-c7feeaca.jpg",ke="/assets/book-6-2a1b145e.jpg",fe="/assets/book-7-f1f63a41.jpg",Ce="/assets/book-8-d45c88d9.jpg",xe="/assets/book-9-3979f14d.jpg",_e="/assets/book-10-7b57edd2.jpg",Ue="/assets/book-11-e8ffdebe.jpg",Ae="/assets/book-12-550a27b3.jpg",Ie="/assets/book-13-e6fe134b.jpg",Se="/assets/book-14-a3da225c.jpg",Te="/assets/book-15-f05c1500.jpg",qe="/assets/book-16-2fd02a2e.jpg",Pe="/assets/book-17-a2c45656.jpg",Le="/assets/book-18-0ed40963.jpg",Me="/assets/book-19-f23c5c43.jpg",je="/assets/book-20-cca40940.jpg",We="/assets/book-21-3cebef2e.jpg",Fe="/assets/book-22-614365f8.jpg",$e="/assets/book-23-83c9686d.jpg",Ee="/assets/book-24-45cb3fa4.jpg",De="/assets/book-25-a1df08d5.jpg",Oe="/assets/book-26-25d42a98.jpg",ze="/assets/book-27-068c84df.jpg",Ge="/assets/book-28-27affa5f.jpg",Be="/assets/book-29-9a890070.jpg",Re="/assets/book-30-6446f4f7.jpg",Ve="/assets/book-31-9a0d3587.jpg",Ne="/assets/book-32-fe624da4.jpg",He="/assets/book-33-76e44512.jpg",Ze="/assets/book-34-497bffa7.jpg",Je="/assets/book-35-04073a16.jpg",Ke="/assets/book-36-a915e63c.jpg",Qe="/assets/book-37-193bca25.jpg",Xe="/assets/book-38-bab41f86.jpg",Ye="/assets/book-39-b7441fea.jpg",ts="/assets/book-40-8a4541ff.jpg",es="/assets/book-41-b37be90d.jpg",ss="/assets/book-42-4b1a7f63.jpg",as="/assets/book-43-6a16d09c.jpg",rs="/assets/book-44-a37c9c2f.jpg",os="/assets/book-45-d2b26293.jpg",is="/assets/book-46-2e27c388.jpg",ns="/assets/book-47-c37fdd68.jpg",ls="/assets/book-48-5467500c.jpg",cs="/assets/book-49-d09acf59.jpg",ds="/assets/book-50-ac3319df.jpg",ps="/assets/book-51-e3ff87d5.jpg",us="/assets/book-52-edf2ced0.jpg",hs="/assets/book-53-e5c94566.jpg",gs="/assets/book-54-7d6016dc.jpg",ms="/assets/book-55-a8001d6d.jpg",vs="/assets/book-56-4eabab64.jpg",bs="/assets/book-57-d00c8f6f.jpg",ws="/assets/book-58-348493a1.jpg",ys="/assets/book-59-1813f385.jpg",ks="/assets/book-60-769a1dec.jpg",fs="/assets/book-61-c1b6b61a.jpg",Cs="/assets/book-62-69461cec.jpg",xs="/assets/book-63-23a1ce9f.jpg",_s="/assets/book-64-c5696860.jpg",Us="/assets/book-65-fce8d399.jpg",As="/assets/book-66-0320b240.jpg",Is="/assets/book-67-50947f32.jpg",Ss="/assets/book-68-5eb79b54.jpg",Ts="/assets/book-69-2967a41b.jpg",qs="/assets/book-70-abf1558a.jpg",Ps="/assets/book-71-7bf5b3bf.jpg",Ls="/assets/book-72-543e86c2.jpg",Ms="/assets/book-73-55bc3d35.jpg",js="/assets/book-74-17cfe1d9.jpg",Ws="/assets/book-75-f0fa4624.jpg",Fs="/assets/book-76-dd4a3546.jpg",$s="/assets/book-77-9f810bf1.jpg",Es="/assets/book-78-5258898c.jpg",Ds="/assets/book-79-fb3930dd.jpg",Os="/assets/book-80-e3b41a45.jpg",zs="/assets/book-81-4df4b61e.jpg",Gs="/assets/book-82-910a8862.jpg",Bs="/assets/book-83-26c022f0.jpg",Rs="/assets/book-84-424075f9.jpg",Vs="/assets/book-85-ea49cc21.jpg",Ns="/assets/book-86-6754ef86.jpg",Hs="/assets/book-87-cac6d5a3.jpg",Zs="/assets/book-88-52068976.jpg",Js="/assets/book-89-60b93083.jpg",Ks="/assets/book-90-d995f684.jpg",Qs="/assets/book-91-c270d1ed.jpg",Xs="/assets/book-92-3017ee15.jpg",Ys="/assets/book-93-57e7e929.jpg",ta="/assets/book-94-54e8791f.jpg",ea="/assets/book-95-beb78880.jpg",sa="/assets/book-96-46252a0b.jpg",aa="/assets/book-97-86485ffd.jpg",ra="/assets/book-98-0a5365df.jpg",oa="/assets/book-99-b9bfe19c.jpg",ia="/assets/book-100-bb5f712d.jpg",na="/assets/book-117-240bb99c.jpg",la="/assets/book-235-f678e4c7.jpg",ca=[{id:1,slug:"没钱修什么仙？",title:"没钱修什么仙？",cover:me,author:"熊狼狗",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-987章",latestChapter:"第987章 终极倒翻昆仑，掌书人(感谢“吴师叔”成为盟主)",excerpt:"老者：“你想报仇？”少年：“我被强者反复侮辱，被师尊视为垃圾，我怎么可能不想报仇？”老者伸出手：“把你手机给我。”少年震惊：“前辈！这哪里来的百年功力？”老者微微一笑：“好孩子，这是你在天庭的备用功力，以后急用的时候随用随取。”张羽冷哼一声，关掉了上面的广告。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/cae0076dd4a8?pwd=fBN8",downloadUrl:"/books/1没钱修什么仙？1-987章.txt",sourceUrl:"https://www.deqixs.org/1/txt.html#dir"},{id:2,slug:"夜无疆",title:"夜无疆",cover:ve,author:"辰东",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-810章",latestChapter:"第810章 一人伐一国【上】",excerpt:"那一天太阳落下再也没有升起。 永夜，天地漆黑，似不可测的深渊要吞噬一切。 白昼早已沦为过往，成为传说。 广袤的冻土，寒风凛冽，暴雪砸落，积在地面足有半人高了。 双树村，被大雪半淹没。 这里只有四五十户人家，像是被岁月遗忘的村庄，成片的房屋在黑夜中只能看到模糊的轮廓。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/9834dec57421?pwd=ZwQh",downloadUrl:"/books/2夜无疆1-810章.txt",sourceUrl:"https://www.deqixs.org/2/txt.html#dir"},{id:3,slug:"苟在武道世界成圣",title:"苟在武道世界成圣",cover:be,author:"在水中的纸老虎",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-883章",latestChapter:"第883章 幽冥（求月票！）",excerpt:'命格在手，苟道求生！ 陈庆穿越了，却穿进一个武道为尊、人命贱如草的乱世。开局便是哑子湾的贫苦渔家子，父亲被抓徭役杳无音信，孤儿寡母被官府税赋与帮派"龙王香火"层层盘剥，挣扎在饿死的边缘。 天无绝人之路，他脑海中悬着一道【命格：天道酬勤，必有所成】！ 这意味着任何技艺，对他而言没有资质门槛，没有瓶颈阻隔，只要付出，必有回报！',tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/a8a5ee24dce0?pwd=9Egc",downloadUrl:"/books/3苟在武道世界成圣1-883章.txt",sourceUrl:"https://www.deqixs.org/3/txt.html#dir"},{id:4,slug:"都重生了谁考公务员啊",title:"都重生了谁考公务员啊",cover:we,author:"柳岸花又明",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-887章",latestChapter:"第887章 、和宋时微的拥抱",excerpt:"省直公务员陈着意外重生自己高三的那一年。于是，一个木讷腼腆、只知道学习的高中生，突然变得通晓人情世故，说话做事恰到好处，不仅改变了人生轨迹，也越来越吸引女孩子的关注。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/be305bbf4963?pwd=P7HA",downloadUrl:"/books/4都重生了谁考公务员啊1-887章.txt",sourceUrl:"https://www.deqixs.org/4/txt.html#dir"},{id:5,slug:"嗣皇帝",title:"嗣皇帝",cover:ye,author:"三山风",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-999章",latestChapter:"第999章 用魔法打败魔法 用人心打败人心",excerpt:"重生到九龙夺嫡的平行世界，沈叶却发现自己竟然成了被群起而攻之的太子。知道太子最大敌人不是那些兄弟，而是越来越猜疑的皇帝，沈叶在发现难以复制玄武门之变后，就决定躺平了！",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/e192c27f42e3?pwd=BSb4",downloadUrl:"/books/5嗣皇帝1-999章.txt",sourceUrl:"https://www.deqixs.org/5/txt.html#dir"},{id:6,slug:"神明调查报告",title:"神明调查报告",cover:ke,author:"黑山老鬼",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-428章",latestChapter:"第428章 即将到来的战争(大结局)",excerpt:"一场来自过去的绑架，十三道屹立于古堡的魅影。循环逆转的人生，神明报复人类而掀起的灾殃！这世界理智很脆弱，人类需要哄着。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/5b9845fb7071?pwd=ge6n",downloadUrl:"/books/6神明调查报告1-428章.txt",sourceUrl:"https://www.deqixs.org/6/txt.html#dir"},{id:7,slug:"吞噬星空2起源大陆",title:"吞噬星空2起源大陆",cover:fe,author:"我吃西红柿",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-452章",latestChapter:"第452章 永恒 （大结局）",excerpt:"罗峰带着界兽摩罗撒闯过轮回，来到了起源大陆……这是《吞噬星空》后续的第二部小说。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/103a63559e78?pwd=dF6b",downloadUrl:"/books/7吞噬星空2起源大陆1-452章.txt",sourceUrl:"https://www.deqixs.org/7/txt.html#dir"},{id:8,slug:"苟在初圣魔门当人材",title:"苟在初圣魔门当人材",cover:Ce,author:"鹤守月满池",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1444章",latestChapter:"第1444章 番外三 这家夫妻俩",excerpt:"吕阳穿越修仙界，却成了魔门初圣宗的弟子。幸得异宝【百世书】，死后可以重开一世，让一切从头再来，还能带回前世的宝物、修为、寿命，甚至觉醒特殊的天赋。眼见修仙界乱世将至，吕阳决定在魔门苟住，一世世苦修。百世之后，他已成为一代魔道巨擘，初圣宗里最畜生的那一个。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/254dbfcf97f2?pwd=HepN",downloadUrl:"/books/8苟在初圣魔门当人材1-1444章.txt",sourceUrl:"https://www.deqixs.org/8/txt.html#dir"},{id:9,slug:"我在惊悚游戏里封神",title:"我在惊悚游戏里封神",cover:xe,author:"壶鱼辣椒",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-589章",latestChapter:"第589章 番外·尾声（317）",excerpt:"白柳在失业后被卷入一个无法停止的惊悚直播游戏中，游戏中充满了各种各样的怪物和蕴含杀意的玩家。后来，他们才明白，是这个游戏用胜利和桂冠在恭迎属于它的神明，对白柳说，欢迎回家。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/0de1e5901403?pwd=P5Xp",downloadUrl:"/books/9我在惊悚游戏里封神1-589章.txt",sourceUrl:"https://www.deqixs.org/9/txt.html#dir"},{id:10,slug:"从斩妖除魔开始长生不死",title:"从斩妖除魔开始长生不死",cover:_e,author:"陆月十九",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-838章",latestChapter:"第838章 终得平静（完）",excerpt:"消耗寿元灌注武学，可无限进行推演。沈仪凡人之躯，寿数不过百年，所幸可以通过斩杀妖魔获取对方剩余寿元。在邪祟遍地的乱世中亮出长刀，从【鹰爪功】到【八荒裂天手】，从【伏魔拳】到【金身镇狱法相】，踏天向诸仙借个百万年，以证长生不死大道。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/3b1d4ae8141d?pwd=udFs",downloadUrl:"/books/10从斩妖除魔开始长生不死1-838章.txt",sourceUrl:"https://www.deqixs.org/10/txt.html#dir"},{id:11,slug:"谁让他修仙的",title:"谁让他修仙的！",cover:Ue,author:"最白的乌鸦",date:"2026-02-22",category:"仙侠",status:"已完结",chapters:"1-1364章",latestChapter:"第1364章 番外一",excerpt:"（新书《请勿高考时渡劫》已发） “我反复强调，修仙界的风气本来就是歪的，不是我带歪的，都说史书是胜利者书写的，那为什么我获胜了还总是有人诬陷我？”陆阳剑仙面对记者采访如此说道，表示非常愤怒。 第二天。 “我反复强调，修仙界的风气是我带歪的，史书是胜利者书写的，我获胜了！”陆阳剑仙面对记者的采访时如此说道，表示非常愤怒。——《修仙日报》为您报道。",tags:[{name:"仙侠",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/5701dd97be2b?pwd=qCFk",downloadUrl:"/books/11谁让他修仙的！1-1364章.txt",sourceUrl:"https://www.deqixs.org/11/txt.html#dir"},{id:12,slug:"玄鉴仙族",title:"玄鉴仙族",cover:Ae,author:"季越人",date:"2026-09-05",category:"仙侠",status:"连载中",chapters:"1-1559章",latestChapter:"第9839章 9951、10452、10467、10491、10501、10547、10615、10659、",excerpt:"陆江仙熬夜猝死，残魂却附在了一面满是裂痕的青灰色铜镜上，飘落到了浩瀚无垠的修仙世界。 凶险难测的大黎山，眉尺河旁小小的村落，一个小家族拾到了这枚镜子，于是传仙道授仙法，开启波澜壮阔的新时代。 (家族修仙，不圣母，种田，无系统，群像文)",tags:[{name:"仙侠",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/a8fc88fe93e0?pwd=fw6p",downloadUrl:"/books/12玄鉴仙族1-1559章.txt",sourceUrl:"https://www.deqixs.org/12/txt.html#dir"},{id:13,slug:"从水猴子开始成神",title:"从水猴子开始成神",cover:Ie,author:"甲壳蚁",date:"2026-09-07",category:"玄幻",status:"连载中",chapters:"1-1482章",latestChapter:"第1482章 南疆机会，蛙族冠军（二合一）",excerpt:"【已有完结七千均大精品，品质保障，放心阅读。】 选择大于努力！ 武师们为陆地宝树打的头破血流，深水神草却无人问津。 穿越成渔民的梁渠获得水泽之鼎，炼化【水猴子】天赋，统御水兽，一路收割，踏上巅峰！ 【水猴子】→【泽狨】→【水王猿】→【淮涡水君】！ 从此万里泽涛由我做主！ 洪水滔滔。 人们跪拜祈福，献上祭品。 “求水神大人保佑......” 靠，能不能别向我祭祀少女了，我真不是水神啊！",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/e463fbe85859?pwd=Rw9i",downloadUrl:"/books/13从水猴子开始成神1-1482章.txt",sourceUrl:"https://www.deqixs.org/13/txt.html#dir"},{id:14,slug:"青山",title:"青山",cover:Se,author:"会说话的肘子",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-797章",excerpt:"飞光飞光，劝尔一杯酒。 吾不识青山高，黄地厚。 唯见月寒日暖，来煎人寿。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/395d361e2194?pwd=RiBb",downloadUrl:"/books/14青山1-797章.txt",sourceUrl:"https://www.deqixs.org/14/txt.html#dir"},{id:15,slug:"神的模仿犯",title:"神的模仿犯",cover:Te,author:"青衫取醉",date:"2026-09-06",category:"游戏",status:"连载中",chapters:"1-840章",latestChapter:"第840章 总分",excerpt:"十二名身份各异的男女被邀请进入新世界。 在这里，他们不仅要通过议案投票来决定自己的生活方式，还要不断参与生死游戏来延长自己的签证时间。 而这些生死游戏的设计者，其实就在他们中间。",tags:[{name:"游戏",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/523042b8eaf5?pwd=QnQg",downloadUrl:"/books/15神的模仿犯1-840章.txt",sourceUrl:"https://www.deqixs.org/15/txt.html#dir"},{id:16,slug:"我的化身正在成为最终boss",title:"我的化身正在成为最终BOSS",cover:qe,author:"汐尺",date:"2026-02-22",category:"轻",status:"已完结",chapters:"1-422章",latestChapter:"第422章 番外一： 世界树的孩子们",excerpt:"平平无奇地生活了十多年后，某天夜里，姬明欢觉醒了一个允许他在现实世界“创建游戏角色”的异能。 并且每一个角色都具备着独特的主线任务、独特的技能树系统。 自那之后他一发不可收拾，在现实世界之中不断创建新的游戏角色、开发技能树、培养角色系统……提升角色的知名度便能加强角色的能力，于是他开始大肆捣乱，为了吸引眼球而无所不用其极。 等回过神时，姬明欢独自一人盘着腿坐在月球上眺望满目苍痍的蓝星，轻声感慨道：",tags:[{name:"轻",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/0093cacca328?pwd=k9Es",downloadUrl:"/books/16我的化身正在成为最终BOSS1-422章.txt",sourceUrl:"https://www.deqixs.org/16/txt.html#dir"},{id:17,slug:"元始法则",title:"元始法则",cover:Pe,author:"飞天鱼",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1271章",excerpt:'星空中的"道城"，修行最初的萌芽之地"祖洲"，浩瀚宇宙水之起源"神仓古泽"，虚暗禁区"战斧座空洞"。还有藏在宏观中的天界，与微观中的地府幽境。地球的微观世界……显微镜下——豆子般大小的佛祖舍利，宛若一颗浅红色星球，研究人员发现了搁浅其中的古老青铜船舰。',tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/3230c869fe53?pwd=Sp5p",downloadUrl:"/books/17元始法则1-1271章.txt",sourceUrl:"https://www.deqixs.org/17/txt.html#dir"},{id:18,slug:"冬日重现",title:"冬日重现",cover:Le,author:"雪梨炖茶",date:"2026-09-06",category:"轻",status:"已完结",chapters:"1-500章",latestChapter:"第500章 后日谈:情人节(下)(月初求票)",excerpt:"张述桐曾有两个女同学： 一个是有钱人家的骄傲大小姐； 一个是在山里当庙祝的清冷少女。 她们一个被杀死在八年前，一个死在了八年后。 张述桐还有一个不可告人的秘密： 他能回到过去。 ... 可好不容易救回了她们，她们怎么自己打起来了？ ... 深山、大湖、神庙、水下的阴影、八年前的连环凶杀案，还有女孩逐渐冰冷的身体； 这是一个发生在冬天的小岛上，一群少男少女之间，有些温馨、有些惊悚、有些浪漫的青春故事",tags:[{name:"轻",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/747c9dc39a25?pwd=JAqV",downloadUrl:"/books/18冬日重现1-500章.txt",sourceUrl:"https://www.deqixs.org/18/txt.html#dir"},{id:19,slug:"普罗之主",title:"普罗之主",cover:Me,author:"沙拉古斯",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-861章",latestChapter:"第861章 普罗万修！（大结局）",excerpt:"他叫李伴峰，为了救朋友去了96号站台，上了1160蒸汽列车，来到停留在蒸汽时代的普罗州。这里有越吃越猛的食修，越抽越强的烟修，越杀越狠的武修。伴峰穿上西装，戴上礼帽，拿上鸡毛掸子，认真问了一句：告诉我，谁是普罗之主？",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/03a571e66d31?pwd=DLGE",downloadUrl:"/books/19普罗之主1-861章.txt",sourceUrl:"https://www.deqixs.org/19/txt.html#dir"},{id:20,slug:"道诡异仙",title:"道诡异仙",cover:je,author:"狐尾的笔",date:"2026-02-28",category:"玄幻",status:"连载中",chapters:"1-1042章",latestChapter:"第1042章 红中传：2",excerpt:"诡异的天道，异常的仙佛，是真？是假？陷入迷惘的李火旺无法分辨。 可让他无法分辨的不仅仅只是这些。还有他自己，他病了，病的很重。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/dc51f50d4dd8?pwd=PQR2",downloadUrl:"/books/20道诡异仙1-1042章.txt",sourceUrl:"https://www.deqixs.org/20/txt.html#dir"},{id:21,slug:"高武纪元",title:"高武纪元",cover:We,author:"烽仙",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-842章",latestChapter:"第843章 完本感言",excerpt:"从南洋深海中飞起的黑龙，掀起灭世海啸……这是人类科技高度发达的未来世界，也是掀起生命进化狂潮的高武纪元。武道学生李源心怀能观想星海的奇异神宫，多年以后，他可称之为武神！",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/48f6e423f3ab?pwd=4eKL",downloadUrl:"/books/21高武纪元1-842章.txt",sourceUrl:"https://www.deqixs.org/21/txt.html#dir"},{id:22,slug:"故障乌托邦",title:"故障乌托邦",cover:Fe,author:"狐尾的笔",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-650章",latestChapter:"第650章 番外：克隆（9）",excerpt:"改装金属义体，AI女友，脑内神经网络，赛博空间，这是一个拥有超高科技的世界。虽然过去的绝症癌症在纳米医疗机器人面前不值一提，然而新科技也会衍生各种各样的新问题，新麻烦，和新的赛博精神病。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/e8d112e30cbe?pwd=ksrd",downloadUrl:"/books/22故障乌托邦1-650章.txt",sourceUrl:"https://www.deqixs.org/22/txt.html#dir"},{id:23,slug:"苟在妖武乱世修仙",title:"苟在妖武乱世修仙",cover:$e,author:"文抄公",date:"2026-02-28",category:"仙侠",status:"已完结",chapters:"1-1102章",latestChapter:"第1102章 番外",excerpt:"方夕穿了，而且是二穿！ 在修仙界我唯唯诺诺，在异世界我重拳出击！ 没想到千百年后，在修仙界也成了大佬！ （苟道长生+无限流，文抄出品，本本精品，请书友们放心收藏阅读）",tags:[{name:"仙侠",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/77662c6223a8?pwd=Ge8Z",downloadUrl:"/books/23苟在妖武乱世修仙1-1102章.txt",sourceUrl:"https://www.deqixs.org/23/txt.html#dir"},{id:24,slug:"苟在两界修仙",title:"苟在两界修仙",cover:Ee,author:"文抄公",date:"2026-09-01",category:"仙侠",status:"连载中",chapters:"1-714章",latestChapter:"第714章 不死",excerpt:"年岁之丰凶，灵氛之运转，阴阳之嬗变——此皆值岁微末之绩耳…… 这是一个少年穿越两界修仙，摸索成为【值岁】的故事……",tags:[{name:"仙侠",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/dad11c04efec?pwd=wGHS",downloadUrl:"/books/24苟在两界修仙1-714章.txt",sourceUrl:"https://www.deqixs.org/24/txt.html#dir"},{id:25,slug:"永噩长夜",title:"永噩长夜",cover:De,author:"zhttty",date:"2026-09-07",category:"玄幻",status:"连载中",chapters:"1-1207章",latestChapter:"第1207章 些许磨砺",excerpt:"未知污染侵袭世界，仙神妖佛尽数沉沦。生化狂潮，蔚蓝再临，奇点登台，人革逆袭…… 来自未来的进化与源自过去的国术相逢，气血磅礴的人仙武道与诡异扭曲的污染相战。 我自长夜之前沉睡，我于永噩之地苏醒，带着未来的无限可能与位面救赎的希望，撼树的蚍蜉也是血溅五步的匹夫，他的故事才刚刚开始。 以下为不正经简介： 我是小西王啊啊啊啊 杀杀杀杀杀杀杀……………………",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/55d6c0f71251?pwd=K7cA",downloadUrl:"/books/25永噩长夜1-1207章.txt",sourceUrl:"https://www.deqixs.org/25/txt.html#dir"},{id:26,slug:"苟圣！",title:"苟圣！",cover:Oe,author:"不偷半日闲",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-533章",latestChapter:"第533章 金鹏",excerpt:"本书又名：《从金刚功开始肉身成圣》 许阳穿越人命如草芥的武道乱世，成为挣扎求存的贱民。 贫贱之身，起初他只想活着，吃一口饱饭。 直到他脑中出现一块【武道长生】面板，面板对他每日行为进行评估、结算，给予点数奖励。 点数可提升寿元、悟性、根骨，添加功法和技艺。 乱世下，他从食不果腹的贱民，渐渐成长为肉身成圣，身体永驻巅峰的盖世无敌强者，世人尊称其为——长生武圣。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/bbde15ec0b96?pwd=J3q3",downloadUrl:"/books/26苟圣！1-533章.txt",sourceUrl:"https://www.deqixs.org/26/txt.html#dir"},{id:27,slug:"浊世武尊",title:"浊世武尊",cover:ze,author:"林守镜",date:"2026-09-07",category:"仙侠",status:"已完结",chapters:"1-505章",latestChapter:"第505章 完结感言",excerpt:"大新民国三年，时局崩裂。南方政府初立，北方军阀割据混战。西洋铁舰叩关，前朝幽魂不散。 这是一个火枪与筋骨争锋、乱党与邪祟共舞的时代——革命暗潮之下，民间邪教滋生，兵武、妖魔、异兽、殖装铁躯… 滂沱雨夜，盛海租界。 傅觉民立于倾颓的巨厦废墟中，缓缓将双手从面前五米高、白头赤足的猿形巨怪胸膛中一点点抽出。 血水混着雨水自他指尖滴落。 “山海遗种，苍生余孽。” “吞了这只蕴含一丝朱厌血脉的异兽魂种，我【",tags:[{name:"仙侠",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/5db3c621619c?pwd=tMXJ",downloadUrl:"/books/27浊世武尊1-505章.txt",sourceUrl:"https://www.deqixs.org/27/txt.html#dir"},{id:28,slug:"废土边境检查官",title:"废土边境检查官",cover:Ge,author:"斤斤斤",date:"2026-09-07",category:"科幻",status:"连载中",chapters:"1-1700章",latestChapter:"第1700章 1450、1300、1300、1250。",excerpt:"穿越到感染体肆虐、天灾不断的废土，程野成为了幸福城的边境检查官。 每一个想要加入幸福城的幸存者，都要被仔细盘问检查，以防感染体混入其中。 但很快，程野发现这些感染体和自己想象的完全不同！ 这里有能让人死而复生、靠执念存活的亡语触手。 有瞬间覆盖两公里，范围感染的死亡蒲公英。 有释放生物解构射线融化一切的火热向日葵。 还有，让生物发笑就能变强的笑面曼陀罗... 什么，要我检查这些怪物？ 幸好，程野获",tags:[{name:"科幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/413aa509b02b?pwd=Y8WU",downloadUrl:"/books/28废土边境检查官1-1700章.txt",sourceUrl:"https://www.deqixs.org/28/txt.html#dir"},{id:29,slug:"Z世代艺术家",title:"Z世代艺术家",cover:Be,author:"起酥面包",date:"2026-09-06",category:"都市",status:"连载中",chapters:"1-557章",latestChapter:"第557章 最后一骂",excerpt:"《从撞碎公知开始推平娱乐圈》 出生于2005年的Z世代水军头子，重生在1998年。 他对于这个时代没有任何滤镜，因此感到强烈窒息。 影视剧粗糙的画质，辣眼的特效，破布般的服装，糊弄鬼一样的妆容，能凑合就凑合的拍摄理念…… 男男女女，导演制片，统统都是垃圾。 少年公平的拷打一切，并且带着怒火揭竿而起。 是时候给华娱一点来自于更高维度的震撼了！ PS：只要我公正的黑每一个人，谁敢骂我是喷子？",tags:[{name:"都市",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/84a3144aecd9?pwd=XRHj",downloadUrl:"/books/29Z世代艺术家1-557章.txt",sourceUrl:"https://www.deqixs.org/29/txt.html#dir"},{id:30,slug:"以神通之名",title:"以神通之名",cover:Re,author:"猪心虾仁",date:"2026-09-05",category:"玄幻",status:"连载中",chapters:"1-16711章",latestChapter:"第16711章 16895、16978",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/74fcf0358890?pwd=1HkB",downloadUrl:"/books/30以神通之名1-16711章.txt",sourceUrl:"https://www.deqixs.org/30/txt.html#dir"},{id:31,slug:"刚准备高考，离婚逆袭系统来了",title:"刚准备高考，离婚逆袭系统来了",cover:Ve,author:"七月封阳",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-970章",latestChapter:"第970章 重逢（正文完结）",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/40206cf31fed?pwd=BjB9",downloadUrl:"/books/31刚准备高考，离婚逆袭系统来了1-970章.txt",sourceUrl:"https://www.deqixs.org/31/txt.html#dir"},{id:32,slug:"都重生了谁谈恋爱啊",title:"都重生了谁谈恋爱啊",cover:Ne,author:"错哪儿了",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-766章",latestChapter:"第766章 最好的人生(全文完)",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/bff91c904ff2?pwd=VkPy",downloadUrl:"/books/32都重生了谁谈恋爱啊1-766章.txt",sourceUrl:"https://www.deqixs.org/32/txt.html#dir"},{id:33,slug:"择日走红",title:"择日走红",cover:He,author:"宋不留春",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1006章",latestChapter:"第1006章 番外：让他应应激吧！",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/019780946456?pwd=etjF",downloadUrl:"/books/33择日走红1-1006章.txt",sourceUrl:"https://www.deqixs.org/33/txt.html#dir"},{id:34,slug:"离婚后，我能听到未来的声音",title:"离婚后，我能听到未来的声音",cover:Ze,author:"林中谷",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-958章",latestChapter:"第958章 上市【终章】",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/9ad55ad87aa3?pwd=NvF5",downloadUrl:"/books/34离婚后，我能听到未来的声音1-958章.txt",sourceUrl:"https://www.deqixs.org/34/txt.html#dir"},{id:35,slug:"国民法医",title:"国民法医",cover:Je,author:"志鸟村",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1356章",latestChapter:"第1356章 终章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/ab268cb1b136?pwd=g8cf",downloadUrl:"/books/35国民法医1-1356章.txt",sourceUrl:"https://www.deqixs.org/35/txt.html#dir"},{id:36,slug:"捞尸人",title:"捞尸人",cover:Ke,author:"纯洁滴小龙",date:"2026-09-03",category:"都市",status:"已完结",chapters:"1-696章",latestChapter:"第696章",excerpt:"人知鬼恐怖，鬼晓人心毒。 这是一本传统灵异小说。",tags:[{name:"都市",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/a5d88e09d092?pwd=vy8U",downloadUrl:"/books/36捞尸人1-696章.txt",sourceUrl:"https://www.deqixs.org/36/txt.html#dir"},{id:37,slug:"踩着魔门妖女成为最强",title:"踩着魔门妖女成为最强",cover:Qe,author:"幽祝",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-859章",latestChapter:"第859章 番外五 后事",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/02c1349feeb0?pwd=S7Na",downloadUrl:"/books/37踩着魔门妖女成为最强1-859章.txt",sourceUrl:"https://www.deqixs.org/37/txt.html#dir"},{id:38,slug:"状元郎",title:"状元郎",cover:Xe,author:"三戒大师",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-902章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/c16cc84bf2bd?pwd=Dsvk",downloadUrl:"/books/38状元郎1-902章.txt",sourceUrl:"https://www.deqixs.org/38/txt.html#dir"},{id:39,slug:"大宋文豪",title:"大宋文豪",cover:Ye,author:"西湖遇雨",date:"2026-09-07",category:"历史",status:"连载中",chapters:"1-691章",latestChapter:"第691章 夫子遇颜，皆朋党耳",excerpt:"少年肝胆悬吴钩，文章笑傲王侯。醉鞭星斗过樊楼，一襟唐气象，半卷宋风流！",tags:[{name:"历史",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/cc194dec6961?pwd=5u92",downloadUrl:"/books/39大宋文豪1-691章.txt",sourceUrl:"https://www.deqixs.org/39/txt.html#dir"},{id:40,slug:"红楼芳华，权倾天下",title:"红楼芳华，权倾天下",cover:ts,author:"爱车的z",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-598章",latestChapter:"第598章 尤氏姐妹上门，一堆美人观战",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/6a6a753749b9?pwd=Xh7W",downloadUrl:"/books/40红楼芳华，权倾天下1-598章.txt",sourceUrl:"https://www.deqixs.org/40/txt.html#dir"},{id:41,slug:"草芥称王",title:"草芥称王",cover:es,author:"月关",date:"2026-09-07",category:"历史",status:"连载中",chapters:"1-522章",latestChapter:"第522章 魅影",excerpt:"接亲途中新郎惨死，为保豪门联姻，新娘竟要我这师爷替身代班？",tags:[{name:"历史",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/89b837ee2c6b?pwd=3dVq",downloadUrl:"/books/41草芥称王1-522章.txt",sourceUrl:"https://www.deqixs.org/41/txt.html#dir"},{id:42,slug:"创业在晚唐",title:"创业在晚唐",cover:ss,author:"痴人陈",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-851章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/d0b91ffa9bce?pwd=gYFf",downloadUrl:"/books/42创业在晚唐1-851章.txt",sourceUrl:"https://www.deqixs.org/42/txt.html#dir"},{id:43,slug:"光阴之外",title:"光阴之外",cover:as,author:"耳根",date:"2026-04-05",category:"仙侠",status:"连载中",chapters:"1-1359章",latestChapter:"第1359章 花开故人来",excerpt:"天地是万物众生的客舍，光阴是古往今来的过客。 死生的差异，就好像梦与醒的不同，纷纭变换，不可究诘。 那么超越了生死，超脱了天地，在光阴之外，等待我们的是什么？ 这是耳根继《仙逆》《求魔》《我欲封天》《一念永恒》《三寸人间》后，创作的第六部长篇小说《光阴之外》",tags:[{name:"仙侠",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/6d6aec538edb?pwd=Uu5H",downloadUrl:"/books/43光阴之外1-1359章.txt",sourceUrl:"https://www.deqixs.org/43/txt.html#dir"},{id:44,slug:"我有一个修仙世界",title:"我有一个修仙世界",cover:rs,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1500章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/54be9cb15619?pwd=Gdxj",downloadUrl:"/books/44我有一个修仙世界1-1500章.txt",sourceUrl:"https://www.deqixs.org/44/txt.html#dir"},{id:45,slug:"从箭术开始修行",title:"从箭术开始修行",cover:os,author:"豆浆油条热干面",date:"2026-04-05",category:"仙侠",status:"已完结",chapters:"1-573章",latestChapter:"第573章 完结感言",excerpt:"陈三石穿越到王朝末年的乱世，幸好有爆肝系统傍身。 他本想打猎挣钱，有朝一日去武馆学两手拳脚，当个普普通通的富家翁。 奈何天不遂人愿，官员横征暴敛，武馆欺凌百姓，他为活命不得不参军入伍，成为一名弓箭手。 从【箭术（入门）】，爆肝到【开万石弓，凡出之箭不可躲避】，百里之外取敌将首级！ 从【兵卒基础枪法】，爆肝到【镇国龙枪，越战越勇】，横枪立马，一人喝退百万敌军！ 多年后，陈三石南征北战，已然天下无敌，",tags:[{name:"仙侠",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/3f0058b8e0ff?pwd=AsYL",downloadUrl:"/books/45从箭术开始修行1-573章.txt",sourceUrl:"https://www.deqixs.org/45/txt.html#dir"},{id:46,slug:"我的模拟长生路",title:"我的模拟长生路",cover:is,author:"愤怒的乌贼",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1782章",latestChapter:"第1782章 完本感言",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/85ff0194e91e?pwd=wv5H",downloadUrl:"/books/46我的模拟长生路1-1782章.txt",sourceUrl:"https://www.deqixs.org/46/txt.html#dir"},{id:47,slug:"我真没想重生啊",title:"我真没想重生啊",cover:ns,author:"柳岸花又明",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1075章",latestChapter:"第1075章 十年",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/98ad363ed041?pwd=AtpH",downloadUrl:"/books/47我真没想重生啊1-1075章.txt",sourceUrl:"https://www.deqixs.org/47/txt.html#dir"},{id:48,slug:"神探陈益",title:"神探陈益",cover:ls,author:"勤奋的关关",date:"2026-04-05",category:"都市",status:"已完结",chapters:"1-808章",latestChapter:"第808章 番外 年节",excerpt:"世界级侦探陈益穿越到平行世界，发现自己被铐在审讯室的椅子上。 他首先要做的，是洗脱自己的杀人嫌疑。 离奇古怪的案件，无法言喻的人心。 从嫌疑人到刑警，从警司到警监，在每个凶案现场，奏响罚罪的刑侦旋律。 这是一个降维打击的刑侦高手，在新的世界破案升职的故事。",tags:[{name:"都市",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/2776b58d6929?pwd=dhdy",downloadUrl:"/books/48神探陈益1-808章.txt",sourceUrl:"https://www.deqixs.org/48/txt.html#dir"},{id:49,slug:"重启人生",title:"重启人生",cover:cs,author:"王梓钧",date:"2026-04-05",category:"都市",status:"已完结",chapters:"1-610章",latestChapter:"第610章 【番外】真正的最后一章了",excerpt:"当人生按下重启键，似乎一切都变得顺利起来……才怪咧！让我重生在高考之后多好啊，实在不行重生去读高一也可以。重生在高三是什么鬼？而且还特么重生在考场。家人们，这道数学题怎么做？急，在线等！…………（本书又名《都重生谁还考试啊》、《都重生了作者还不会取书名》。）",tags:[{name:"都市",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/8ce0866f3226?pwd=VEMF",downloadUrl:"/books/49重启人生1-610章.txt",sourceUrl:"https://www.deqixs.org/49/txt.html#dir"},{id:50,slug:"三国-夫人-我乃正经人家",title:"三国：夫人，我乃正经人家",cover:ds,author:"树叶里的星星",date:"2026-04-05",category:"历史",status:"已完结",chapters:"1-816章",latestChapter:"第816章 后记（终）！",excerpt:"穿越汉末，到中山郡无极县，竟然是一个流民！不过，庆幸的是，每天在外裸露上半身锻炼半个时辰，可以长0.1斤力气，甚至还有机会出现暴击率。名门甄家招募部曲？张遂被选拔入内。略微露了两手之后，张遂发现，夫人看自己的眼神有些怪！二小姐甄宓怎么总是对自己冷脸相向？五小姐动不动就喜欢找自己玩，表示长大以后要嫁给自己。迎着身材丰腴，三十好几，却像少女般的夫人张氏那复杂的目光，张遂一脸心虚道：“夫人，我真是正经人",tags:[{name:"历史",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/81adc0b85ec2?pwd=PcS4",downloadUrl:"/books/50三国：夫人，我乃正经人家1-816章.txt",sourceUrl:"https://www.deqixs.org/50/txt.html#dir"},{id:51,slug:"晋末长剑",title:"晋末长剑",cover:ps,author:"孤独麦客",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1516章",latestChapter:"第1516章 后记三",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/039dccca61c5?pwd=N8UX",downloadUrl:"/books/51晋末长剑1-1516章.txt",sourceUrl:"https://www.deqixs.org/51/txt.html#dir"},{id:52,slug:"红楼之挽天倾",title:"红楼之挽天倾",cover:us,author:"林悦南兮",date:"2026-04-06",category:"历史",status:"已完结",chapters:"1-1726章",latestChapter:"第1726章 盛鼎元年，万象更新！（大结局）",excerpt:"千红一哭，万艳同悲。白骨如山忘姓氏，无非公子与红妆。后世青年魂穿红楼世界中宁国远亲之上，为了免于被贾府牵连之命运，只好步步为营，然而茫然四顾，发现家国天下，乱世将临，为不使神州陆沉，遍地膻腥，只好提三尺剑，扫不臣，荡贼寇，平鞑虏，挽天倾！这一切，从截胡秦可卿开始……",tags:[{name:"历史",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/16c3c4d10b83?pwd=B2su",downloadUrl:"/books/52红楼之挽天倾1-1726章.txt",sourceUrl:"https://www.deqixs.org/52/txt.html#dir"},{id:53,slug:"明朝败家子",title:"明朝败家子",cover:hs,author:"上山打老虎额",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-0章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/4b7a574ae06c?pwd=GW9k",downloadUrl:"/books/53明朝败家子1-0章.txt",sourceUrl:"https://www.deqixs.org/53/txt.html#dir"},{id:54,slug:"家父汉高祖",title:"家父汉高祖",cover:gs,author:"历史系之狼",date:"2026-04-06",category:"历史",status:"已完结",chapters:"1-913章",latestChapter:"第913章 幻想番外：祖庙",excerpt:"新书《衣冠不南渡》火热连载中，求支持！ ………… 一个伟大的帝国刚刚诞生，新的时代即将到来。 刘长也曾想过要不要争一争那大位，由自己来率领这个崭新的帝国，可是他看了看自己的周围，刘邦，吕后，刘盈，刘恒...嗯，活着不好吗？ 于是乎，刘长戴上了穿越者之耻的帽子，开始了混吃等死的咸鱼生活。 又名《我愚蠢的欧豆豆》，《这娃其实是项羽的吧？》，《跟你这样的虫豸怎么能治好大汉》等等。",tags:[{name:"历史",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/262ef49f5e6a?pwd=vaLt",downloadUrl:"/books/54家父汉高祖1-913章.txt",sourceUrl:"https://www.deqixs.org/54/txt.html#dir"},{id:55,slug:"终宋",title:"终宋",cover:ms,author:"怪诞的表哥",date:"2026-04-06",category:"历史",status:"已完结",chapters:"1-1369章",latestChapter:"第1369章 完本感言",excerpt:"终宋一朝都未收复燕云，终宋一朝皆被外敌欺侮……南宋将亡之际，那些终宋一朝都没能达成的伟业，他要做到。",tags:[{name:"历史",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/a1ec610c1b35?pwd=SH9Z",downloadUrl:"/books/55终宋1-1369章.txt",sourceUrl:"https://www.deqixs.org/55/txt.html#dir"},{id:56,slug:"炮火弧线",title:"炮火弧线",cover:vs,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-788章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/87a73003d32f?pwd=1JLf",downloadUrl:"/books/56炮火弧线1-788章.txt",sourceUrl:"https://www.deqixs.org/56/txt.html#dir"},{id:57,slug:"我的谍战岁月",title:"我的谍战岁月",cover:bs,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-2106章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/27111aed5a81?pwd=PA2j",downloadUrl:"/books/57我的谍战岁月1-2106章.txt",sourceUrl:"https://www.deqixs.org/57/txt.html#dir"},{id:58,slug:"谍影：命令与征服",title:"谍影：命令与征服",cover:ws,author:"拉丁海十三郎",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-2074章",latestChapter:"第2075章 大结局",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/811fbf81c5b8?pwd=EvUy",downloadUrl:"/books/58谍影：命令与征服1-2074章.txt",sourceUrl:"https://www.deqixs.org/58/txt.html#dir"},{id:59,slug:"谍海猎影",title:"谍海猎影",cover:ys,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1407章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/f16c24972fde?pwd=Yup7",downloadUrl:"/books/59谍海猎影1-1407章.txt",sourceUrl:"https://www.deqixs.org/59/txt.html#dir"},{id:60,slug:"佣兵我为王",title:"佣兵我为王",cover:ks,author:"严七官",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1850章",latestChapter:"第1850章 大规模押送",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/82d07f9750b1?pwd=UGrg",downloadUrl:"/books/60佣兵我为王1-1850章.txt",sourceUrl:"https://www.deqixs.org/60/txt.html#dir"},{id:61,slug:"谍影风云",title:"谍影风云",cover:fs,author:"寻青藤",date:"2026-04-06",category:"军事",status:"已完结",chapters:"1-1222章",latestChapter:"第1222章 完本感言",excerpt:"一个平凡普通的公务员，机缘巧合回到了1936年，寻找地下组织，追查日本间谍，在波澜壮阔的大时代中为祖国，为民族的解放与复兴贡献着自己的一份力量，开始了他传奇的谍海生涯。谍影风云书友1群833528943，谍影风云书友2群879936725谍影风云舵主940510849",tags:[{name:"军事",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/e7d7d09026ff?pwd=ks7w",downloadUrl:"/books/61谍影风云1-1222章.txt",sourceUrl:"https://www.deqixs.org/61/txt.html#dir"},{id:62,slug:"谁教你这么当兵的！",title:"谁教你这么当兵的！",cover:Cs,author:"东流不鸽",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-729章",latestChapter:"第729章 孟天行：要不要这么现实？ 【求订！ 求月票！ 】",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/1df62d67076a?pwd=B7er",downloadUrl:"/books/62谁教你这么当兵的！1-729章.txt",sourceUrl:"https://www.deqixs.org/62/txt.html#dir"},{id:63,slug:"横推亮剑",title:"横推亮剑",cover:xs,author:"穷玩战术富玩火力",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1163章",latestChapter:"第1163章 不说，不说（大结局）",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/682bf8b54aa8?pwd=scBJ",downloadUrl:"/books/63横推亮剑1-1163章.txt",sourceUrl:"https://www.deqixs.org/63/txt.html#dir"},{id:64,slug:"谍战-都别猜了-我真是卧底啊",title:"谍战，都别猜了，我真是卧底啊",cover:_s,author:"丛拾",date:"2026-09-07",category:"军事",status:"已完结",chapters:"1-353章",latestChapter:"第353章 该做个了结了",excerpt:"【谍战+物资买卖+全球博弈+顶级爽文】 【铭记历史，缅怀先烈，奋勇前行——纪念抗战胜利80周年征文一等奖作品】 民国二十七年，身兼多重身份的特工陈阳奉命潜伏在日伪机关，为组织上提供情报，为了更好的潜伏，获得日本人的信任，陈阳设下诱饵，交织网络，大肆笼络日军后勤部官员。 日本人:“陈桑，我怀疑我们中出了内奸。” 陈阳:“没错，我就是那个内奸。” 日本人:“陈桑.请不要开这种玩笑，一点都不好笑。” “",tags:[{name:"军事",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/75e283ed0653?pwd=B18x",downloadUrl:"/books/64谍战，都别猜了，我真是卧底啊1-353章.txt",sourceUrl:"https://www.deqixs.org/64/txt.html#dir"},{id:65,slug:"谍战：我能扫描万物信息",title:"谍战：我能扫描万物信息",cover:Us,author:"山怪与西风",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-712章",latestChapter:"第712章 零号",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/5c507a4e4499?pwd=GgLE",downloadUrl:"/books/65谍战：我能扫描万物信息1-712章.txt",sourceUrl:"https://www.deqixs.org/65/txt.html#dir"},{id:66,slug:"堑壕大栓与魔法",title:"堑壕大栓与魔法",cover:As,author:"咸嘉湖灵感大王",date:"2026-09-07",category:"科幻",status:"连载中",chapters:"1-596章",latestChapter:"第596章 火力不足恐惧症复发",excerpt:"莫林被人一拳打醒后，发现自己成了个战俘。原以为这是个类似一战爆发前夜的世界，却发现实际情况比自己想得更糟糕。而且为什么我一个帝国士兵，和国际纵队的志愿者成了盟军啊！铁罐头一样的手持剑盾的突击士兵，柴油和魔导混动的装甲骑士，还有随军法师......这一切都在告诉莫林，这个世界有问题，还很大。但他现在要考虑的，是如何在这场号称‘终结一切战争’的战争中，活下来。本书要素：魔改一战、真男人就要拉大栓、柴油",tags:[{name:"科幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/84abb910d3c5?pwd=bagC",downloadUrl:"/books/66堑壕大栓与魔法1-596章.txt",sourceUrl:"https://www.deqixs.org/66/txt.html#dir"},{id:67,slug:"四十九条末世规则",title:"四十九条末世规则",cover:Is,author:"小草昂扬",date:"2026-09-06",category:"科幻",status:"连载中",chapters:"1-707章",latestChapter:"第707章 ：“同类”",excerpt:"携带着末世规则的神秘存在“盗火者”突然降临在天水星。只有通过全部四十九条末世规则考验的人类，才能抵达一切秘密的根源。【末世规则一：睡眠剥夺】【规则内容：规则发布起，72小时内不能以任何形式进入睡眠状态】【失败惩罚：规则时间内一旦进入睡眠状态，将再也无法醒来】社会动荡、世界崩坏。在全球都笼罩在末世规则的恐怖阴影之际……穿越者关瞳，发现他竟然能看到规则背后的“隐藏规则”。",tags:[{name:"科幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/4bf1949bb230?pwd=62ha",downloadUrl:"/books/67四十九条末世规则1-707章.txt",sourceUrl:"https://www.deqixs.org/67/txt.html#dir"},{id:68,slug:"第一序列",title:"第一序列",cover:Ss,author:"会说话的肘子",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1260章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/ed240f0e9f52?pwd=QKSS",downloadUrl:"/books/68第一序列1-1260章.txt",sourceUrl:"https://www.deqixs.org/68/txt.html#dir"},{id:69,slug:"异度旅社",title:"异度旅社",cover:Ts,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-888章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/001ff435f0a0?pwd=5tzv",downloadUrl:"/books/69异度旅社1-888章.txt",sourceUrl:"https://www.deqixs.org/69/txt.html#dir"},{id:70,slug:"灵境行者",title:"灵境行者",cover:qs,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1020章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/a9d4e4843338?pwd=Gtqx",downloadUrl:"/books/70灵境行者1-1020章.txt",sourceUrl:"https://www.deqixs.org/70/txt.html#dir"},{id:71,slug:"超人灭绝指南",title:"超人灭绝指南",cover:Ps,author:"汐尺",date:"2026-09-08",category:"轻",status:"连载中",chapters:"1-223章",latestChapter:"第223章 圆桌会议，夏柯家的视频通话（日更万字求月票！）",excerpt:"我叫柯明庆，一觉醒来我穿越了，伴随而来的是一个难度绝巅的死亡任务：【在半年内灭绝超人种】。 而我的当务之急，是干掉这六个身手不凡的超人种家人。",tags:[{name:"轻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/659ecd1b1d46?pwd=vTDu",downloadUrl:"/books/71超人灭绝指南1-223章.txt",sourceUrl:"https://www.deqixs.org/71/txt.html#dir"},{id:72,slug:"吞噬星空",title:"吞噬星空",cover:Ls,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1522章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/609eaa4fd1e0?pwd=Jnv8",downloadUrl:"/books/72吞噬星空1-1522章.txt",sourceUrl:"https://www.deqixs.org/72/txt.html#dir"},{id:73,slug:"黎明之剑",title:"黎明之剑",cover:Ms,author:"远瞳",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1597章",latestChapter:"第1597章 番外边际漫游者",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/db1a7b68f844?pwd=6brB",downloadUrl:"/books/73黎明之剑1-1597章.txt",sourceUrl:"https://www.deqixs.org/73/txt.html#dir"},{id:74,slug:"黄昏分界",title:"黄昏分界",cover:js,author:"黑山老鬼",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-871章",latestChapter:"第871章 太岁之终，轮回之始",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/0d3534ed9df2?pwd=wVgm",downloadUrl:"/books/74黄昏分界1-871章.txt",sourceUrl:"https://www.deqixs.org/74/txt.html#dir"},{id:75,slug:"学霸的军工科研系统",title:"学霸的军工科研系统",cover:Ws,author:"十月廿二",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1708章",latestChapter:"第1708章 太阳的距离（大结局）",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/6e1e8aaff247?pwd=5RCB",downloadUrl:"/books/75学霸的军工科研系统1-1708章.txt",sourceUrl:"https://www.deqixs.org/75/txt.html#dir"},{id:76,slug:"百世飞升",title:"百世飞升",cover:Fs,author:"白眉罗汉",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-963章",latestChapter:"第963章 证道成仙，九世终结",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/8f5d5f6d1758?pwd=itNu",downloadUrl:"/books/76百世飞升1-963章.txt",sourceUrl:"https://www.deqixs.org/76/txt.html#dir"},{id:77,slug:"恭喜发财",title:"恭喜发财",cover:$s,author:"徐徐图之",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-45章",latestChapter:"第45章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/996cdcd07af1?pwd=c7i5",downloadUrl:"/books/77恭喜发财1-45章.txt",sourceUrl:"https://www.deqixs.org/77/txt.html#dir"},{id:78,slug:"窈窕贵女-疯犬好逑",title:"窈窕贵女，疯犬好逑",cover:Es,author:"罗敷媚歌",date:"2026-04-09",category:"言情",status:"已完结",chapters:"1-87章",latestChapter:"第87章 弃犬3:并非华贵之物，和它的主人一样",excerpt:"【明艳骄纵美人 * 覆面自卑疯犬】 前世，萧玉芙出身高贵，从未将父亲带回的那个外室的儿子萧檀看进眼里过。 更何况，他从人憎鬼恶的酷吏，到权倾朝野位极人臣的手段并不光彩。 而她嫁得门当户对的如玉郎君，与夫君相敬如",tags:[{name:"言情",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/c09f525c46b0?pwd=eD7r",downloadUrl:"/books/78窈窕贵女，疯犬好逑1-87章.txt",sourceUrl:"https://www.deqixs.org/78/txt.html#dir"},{id:79,slug:"剑走偏锋的大明",title:"剑走偏锋的大明",cover:Ds,author:"未知",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1126章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/f13dbbd391e1?pwd=8ZNX",downloadUrl:"/books/79剑走偏锋的大明1-1126章.txt",sourceUrl:"https://www.deqixs.org/79/txt.html#dir"},{id:80,slug:"圣女来时不纳粮",title:"圣女来时不纳粮",cover:Os,author:"稚嫩小菠萝",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-1372章",latestChapter:"第1372章 最后黎明（下）（7k）（大结局）",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/136bfea1b110?pwd=b4hK",downloadUrl:"/books/80圣女来时不纳粮1-1372章.txt",sourceUrl:"https://www.deqixs.org/80/txt.html#dir"},{id:81,slug:"攻略咸鱼的错误方式",title:"攻略咸鱼的错误方式",cover:zs,author:"长明夜",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-79章",latestChapter:"第79章 if线四",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/41558564d90f?pwd=KRUA",downloadUrl:"/books/81攻略咸鱼的错误方式1-79章.txt",sourceUrl:"https://www.deqixs.org/81/txt.html#dir"},{id:82,slug:"哥你不许打我老公！！",title:"哥你不许打我老公！！",cover:Gs,author:"流初",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-409章",latestChapter:"第116章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/719dc51c27a7?pwd=pEBv",downloadUrl:"/books/82哥你不许打我老公！！1-409章.txt",sourceUrl:"https://www.deqixs.org/82/txt.html#dir"},{id:83,slug:"理想之城",title:"理想之城",cover:Bs,author:"非天夜翔",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-132章",latestChapter:"第132章 48-8",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/08593e9d364e?pwd=LzTF",downloadUrl:"/books/83理想之城1-132章.txt",sourceUrl:"https://www.deqixs.org/83/txt.html#dir"},{id:84,slug:"卷崽穿到反派幼年期[快穿]",title:"卷崽穿到反派幼年期[快穿]",cover:Rs,author:"日落黄ovo",date:"2026-04-09",category:"言情",status:"已完结",chapters:"1-269章",latestChapter:"第269章",excerpt:"上辈子严格执行内卷计划的祝无虞，小小年纪就把自己卷没了。 事实证明修炼不能代替睡觉，会猝死！ 死后被系统绑定，让他穿到各种龙傲天文里，成为反派幼崽改写be结局。 祝无虞活动了下新的身体决定从头卷起。 系统：“禁止做出违背原主人设的事情。” 并不想偷懒中二叛逆脾气大攻击所有人毁灭全世界的卷卷：“哦T^T” 【母亲早逝，骄纵阴郁的婚生子 原剧情中他欺负男主，成为压垮骆驼的最后一根稻草。 卷卷穿来后，发",tags:[{name:"言情",type:"purple"},{name:"完结",type:"blue"}],readUrl:"https://pan.quark.cn/s/2290ee3d9f4d?pwd=N5Pd",downloadUrl:"/books/84卷崽穿到反派幼年期[快穿]1-269章.txt",sourceUrl:"https://www.deqixs.org/84/txt.html#dir"},{id:85,slug:"我，枪神！",title:"我，枪神！",cover:Vs,author:"如水意",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-527章",latestChapter:"第527章 逐渐开始暴躁",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/395285a4d30e?pwd=bYQL",downloadUrl:"/books/85我，枪神！1-527章.txt",sourceUrl:"https://www.deqixs.org/85/txt.html#dir"},{id:86,slug:"情天娃娃气象电台",title:"情天娃娃气象电台",cover:Ns,author:"礼物袜子",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-90章",latestChapter:"第90章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/798b1bdc51a1?pwd=Ce2Q",downloadUrl:"/books/86情天娃娃气象电台1-90章.txt",sourceUrl:"https://www.deqixs.org/86/txt.html#dir"},{id:87,slug:"直男卖腐天打雷劈",title:"直男卖腐天打雷劈",cover:Hs,author:"半个水瓶",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-191章",latestChapter:"第191章 第191章:足球番外",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/716317724408?pwd=yQhS",downloadUrl:"/books/87直男卖腐天打雷劈1-191章.txt",sourceUrl:"https://www.deqixs.org/87/txt.html#dir"},{id:88,slug:"再婚abo",title:"再婚abo",cover:Zs,author:"七流",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-84章",latestChapter:"第84章 正文完",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/c64f96030bd8?pwd=fFP5",downloadUrl:"/books/88再婚abo1-84章.txt",sourceUrl:"https://www.deqixs.org/88/txt.html#dir"},{id:89,slug:"剑烛大荒",title:"剑烛大荒",cover:Js,author:"爱潜水的乌贼",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-0章",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/d2fb9a3ed7a0?pwd=Gatz",downloadUrl:"/books/89剑烛大荒1-0章.txt",sourceUrl:"https://www.deqixs.org/89/txt.html#dir"},{id:90,slug:"星河之主",title:"星河之主",cover:Ks,author:"烽仙",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-387章",latestChapter:"第387章 宇宙神通【6K求月票】",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/16e073b15797?pwd=JSVD",downloadUrl:"/books/90星河之主1-387章.txt",sourceUrl:"https://www.deqixs.org/90/txt.html#dir"},{id:91,slug:"我正经学生-每天只吃九种魔药",title:"我正经学生，每天只吃九种魔药",cover:Qs,author:"鬼谷道长",date:"2026-09-06",category:"轻",status:"连载中",chapters:"1-303章",latestChapter:"第303章 ：连喝五瓶融合魔药",excerpt:"伊文穿越成卖血试药的学生，获得天赋面板。【九龙之力：你可以同时将九种药物的负作用反转】贤者大学：最新安眠药，来能熬夜的学生。你服用【未完成的冬眠魔药】：认知受损，五天睡不醒。反转效果：五天内可以入梦学习。红国王实验室：实验型生长药剂，后果自负。你服用【二阶段D病毒】：肌肉增生，血液凝固。反转效果：体质+0.3，增加肉体延展性。治愈教会：来耐药性强的孤儿。你服用【？？？】：皮肤溃烂，内脏融化，精神突",tags:[{name:"轻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/5475f89c0fdf?pwd=tay1",downloadUrl:"/books/91我正经学生，每天只吃九种魔药1-303章.txt",sourceUrl:"https://www.deqixs.org/91/txt.html#dir"},{id:92,slug:"廓晋",title:"廓晋",cover:Xs,author:"榴弹怕水",date:"2026-09-07",category:"历史",status:"连载中",chapters:"1-2章",latestChapter:"第2章 夜雨（续）",excerpt:"廓者，一曰扩，二曰清。既至东晋十六国，当中流击水，矢志北伐，先驱中原五胡，再扫朝堂士族门阀。所谓廓清天下，开创新业，延续华夏。道理上是如此，但永和五年，公元349年的秋日，当穿越者来到东晋，成为东晋朝最常见的流民之一后，首先要考虑的是，今年冬天怎么熬过去？如何避免跌落斩杀线？又是一本老套的穿越故事。",tags:[{name:"历史",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/0090de8fdf62?pwd=x1nE",downloadUrl:"/books/92廓晋1-2章.txt",sourceUrl:"https://www.deqixs.org/92/txt.html#dir"},{id:93,slug:"谁让他当假面骑士的",title:"谁让他当假面骑士的！",cover:Ys,author:"拿咚蘸柚子酱",date:"2026-09-07",category:"轻",status:"连载中",chapters:"1-324章",latestChapter:"第324章 心灵冲击！我会为你带来，比梦魇更绝望的噩梦！",excerpt:"以下是新一代骑士界领袖，著名粉红色骑士代言人，黑榜投票独断万古——假面骑士帝骑先生，于联邦最不受欢迎骑士投票现场的采访对话：记者：“帝骑先生，请问您如何看待零一对您是谜语人的评价？”帝骑：“那纯属造谣！世人皆知我帝骑为人坦荡，从不说谜语，那都是大白话。”记者：“那关于剑与圣刃联名倡议，抵制帝骑使用FFR将他们变成武器这件事，您作何感想？”帝骑：“那不是他们心善，看我没武器，自愿的吗？”记者：“..",tags:[{name:"轻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/b762f1b1427e?pwd=MMCS",downloadUrl:"/books/93谁让他当假面骑士的！1-324章.txt",sourceUrl:"https://www.deqixs.org/93/txt.html#dir"},{id:94,slug:"我加载了神秘学面板",title:"我加载了神秘学面板",cover:ta,author:"雨中有秋云",date:"2026-09-07",category:"奇幻",status:"连载中",chapters:"1-507章",latestChapter:"第507章 与蛇共舞",excerpt:"蒸汽时代，理性与神秘主义并行。知道得越多，离疯狂越近，这是帷幕后的共识。李察不信这个。或者说，这条规则对他不适用。技能面板让他多领域涉猎，却都能精通，像一台不需要停机的蒸汽机。……【呼吸Lv.3&#183;疗愈：沉疴尽退，旧疾全消】【学识Lv.3&#183;博闻：凡经目之典籍，皆留痕于大脑。】【灵Lv.1&#183;出窍：灵魂可短暂挣脱肉身】……【呼吸Lv.5&#183;元素：以呼吸牵动以太，统合",tags:[{name:"奇幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/1ac6abe0b9e2?pwd=icCD",downloadUrl:"/books/94我加载了神秘学面板1-507章.txt",sourceUrl:"https://www.deqixs.org/94/txt.html#dir"},{id:95,slug:"真实历史游戏-只有我知道剧情",title:"真实历史游戏：只有我知道剧情",cover:ea,author:"余弦公式",date:"2026-08-10",category:"游戏",status:"连载中",chapters:"1-448章",latestChapter:"第448章 【第五更，为盟主“阿毛爱吃肉”加更】 自毁长城！",excerpt:"“那个叫马谡的思路很清晰嘛，街亭之战胜负手就在山上！连山都不敢占的，都是庸才，根本不足为虑！”“别去斯大林格勒卷了，我刚从西线副本出来，德军的闪电战就是无敌的，苏联那嘎达撑不过三个月！”“滑铁卢？拿破仑的指挥能力肯定是满级的，会输只有一个可能，就是他手下的元帅全是内鬼！”“土木堡决战！五十万对两万，优势在我！大明皇帝可是御驾亲征，一波平推过去就行了，怎么输？”……曾经滚瓜烂熟的历史，如今变成了一个",tags:[{name:"游戏",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/725be5761e21?pwd=Snr2",downloadUrl:"/books/95真实历史游戏：只有我知道剧情1-448章.txt",sourceUrl:"https://www.deqixs.org/95/txt.html#dir"},{id:96,slug:"让仙门再次伟大",title:"让仙门再次伟大",cover:sa,author:"鹤守月满池",date:"2026-09-07",category:"玄幻",status:"连载中",chapters:"1-8262章",latestChapter:"第8262章 8350、8792、9172、9178、9352、9467、9832、9908、10117、10356、10479、",excerpt:"“承认吧，你根本无法忍受那些高高在上的修行者。”“他们与我们不同，我们的情感无法共通，我们的逻辑大不相同，共存绝无可能。”王平话音落下，一方巍峨书册徐徐翻开。任你洞天福地，红尘世俗，王侯将相，漫天仙佛，都不过是书中的一道道经卷，是他这位书主的修行资粮。“所以现在是时候了，我们将战斗！”“在人间战斗，在梵国战斗，在清虚天战斗，在每一个矢志抗争的地方战斗！”“哪怕要燃烧大地，焚灭天空。”人群中央，王平",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/1d8c5405bdc2?pwd=YkRW",downloadUrl:"/books/96让仙门再次伟大1-8262章.txt",sourceUrl:"https://www.deqixs.org/96/txt.html#dir"},{id:97,slug:"1984：从破产川菜馆开始",title:"1984：从破产川菜馆开始",cover:aa,author:"轻语江湖",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-18699章",latestChapter:"第628章 人家孔派门面办庆功宴，你去又唱又跳不太合适",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/576ad855b7b9?pwd=QYwQ",downloadUrl:"/books/971984：从破产川菜馆开始1-18699章.txt",sourceUrl:"https://www.deqixs.org/97/txt.html#dir"},{id:98,slug:"我在永夜打造庇护所",title:"我在永夜打造庇护所",cover:ra,author:"中世纪的兔子",date:"2026-09-07",category:"玄幻",status:"连载中",chapters:"1-411章",latestChapter:"第411章 什么叫王诡是你大哥？",excerpt:"陈凡穿越至一个诡异玄幻世界中，在这个世界，黑夜降临后，无数诡物肆虐人间。 他通过穿越自带的永夜领主面板成为一名建筑师，一点一点在荒原上打造属于自己的营地。 诡火、城墙、祭塔，一座座建筑凭空升起，他的名声也渐渐响彻整个江北。 直至—— 当「终极天灾」降临，无数疯狂的诡物危害人间，民不聊生之时。 一座横贯大陆的万里长城，凭空升起！ ... “这里是永夜大陆。” “我的地盘。”",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/296c0fa7f14d?pwd=BzYQ",downloadUrl:"/books/98我在永夜打造庇护所1-411章.txt",sourceUrl:"https://www.deqixs.org/98/txt.html#dir"},{id:99,slug:"这个武圣太谨慎了无删减",title:"这个武圣太谨慎了无删减",cover:oa,author:"九灯和善",date:"2026-08-03",category:"玄幻",status:"连载中",chapters:"1-265章",latestChapter:"第265章 拍卖（加更求订阅）",excerpt:"【防御性出手】【出手必碾压】【杀伐果断】【人情世故】 “我真不惹事，只是防御性先下手为强。” 穿越到武道世界普通少年身上的林砚，靠着穿越自带的武道树，本来只想默默发育，求一个逍遥自由。 没曾想，因着没背景靠山，高门权贵处处针对，连看门的狗都要朝他狂吠几声。 出于自保他只能防御性出手，提前将危机扼杀在摇篮中、 靠着这份谨慎，以及武道树的亿点点帮助，林砚在这波澜壮阔的世界中，谱写下独属于他的传奇。 …",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/1318e1363662?pwd=bn7i",downloadUrl:"/books/99这个武圣太谨慎了无删减1-265章.txt",sourceUrl:"https://www.deqixs.org/99/txt.html#dir"},{id:100,slug:"这个武圣太谨慎了",title:"这个武圣太谨慎了",cover:ia,author:"九灯和善",date:"2026-09-07",category:"玄幻",status:"连载中",chapters:"1-322章",latestChapter:"第322章 秘境（求月票）",excerpt:"【防御性出手】【出手必碾压】【杀伐果断】【人情世故】 “我真不惹事，只是防御性先下手为强。” 穿越到武道世界普通少年身上的林砚，靠着穿越自带的武道树，本来只想默默发育，求一个逍遥自由。 没曾想，因着没背景靠山，高门权贵处处针对，连看门的狗都要朝他狂吠几声。 出于自保他只能防御性出手，提前将危机扼杀在摇篮中、 靠着这份谨慎，以及武道树的亿点点帮助，林砚在这波澜壮阔的世界中，谱写下独属于他的传奇。 …",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/bd4fd4ef8142?pwd=SCPj",downloadUrl:"/books/100这个武圣太谨慎了1-322章.txt",sourceUrl:"https://www.deqixs.org/100/txt.html#dir"},{id:117,slug:"腐朽世界",title:"腐朽世界",cover:na,author:"滚开",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-608章",excerpt:"神秘，绝望，痛苦，腐朽，世界走向迷途。来到一个正在走向末路的世界，危机四伏，渺无希望，我只能依靠身上的神秘血印，不断推演进化各类技能，尝试走出一条绝望生路。",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/05b89ee8f5fd?pwd=AxYb",downloadUrl:"/books/117腐朽世界1-608章.txt",sourceUrl:"https://www.deqixs.org/117/txt.html#dir"},{id:145,slug:"武道！",title:"武道！",cover:ge,author:"田隶",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-148章",latestChapter:"第148章 吊起来打（4k字，求月票，1.9万月票加更！）",excerpt:"",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/39c5a2a47478?pwd=VaDT",downloadUrl:"/books/145武道！1-148章.txt",sourceUrl:"https://www.deqixs.org/145/txt.html#dir"},{id:235,slug:"我命令你成为密教教主",title:"我命令你成为密教教主",cover:la,author:"刀如故",date:"2026-09-09",category:"玄幻",status:"连载中",chapters:"1-835章",excerpt:"煤气灯映着巨大的差分机，艾略特推动桌前推杆，机械低沉嗡鸣，弹出一张张卡牌。 「看看有没有特殊事件吧。」 卡牌在桌上移动，【迷茫的少女】被推入卡槽【夜游】，指向【繁华的城市】。 凡妮莎身形一僵，无形之力操纵着她的躯体，迈步走向了灯火。 她路过街边的尸骸，她看着腐朽的繁荣，她直面被践踏的一切。 她的眼中再无喜悲：「原来如此，这就是您想让我看到的一切吗？我的主。」 【迷茫的少女】→【虔信的少女】 「我将",tags:[{name:"玄幻",type:"purple"},{name:"连载",type:"blue"}],readUrl:"https://pan.quark.cn/s/feca96171325?pwd=frci",downloadUrl:"/books/235我命令你成为密教教主1-835章.txt",sourceUrl:"https://www.deqixs.org/235/txt.html#dir"}],da=["仙侠","军事","历史","奇幻","游戏","玄幻","科幻","言情","轻","都市"],pa=["玄幻","连载","仙侠","完结","游戏","轻","科幻","都市","历史","军事","言情","奇幻"];const ua={name:"BookFilterSection",components:{DropdownFilter:O},props:{},data(){return{allBookCategories:da,allBookTags:pa,filters:{categories:[],tags:[],keyword:""}}},computed:{hasFilters(){return this.filters.categories.length>0||this.filters.tags.length>0||this.filters.keyword!==""}},watch:{filters:{deep:!0,handler(s){this.$emit("filter-change",{...s})}}},methods:{handleSearch(){this.$emit("filter-change",{...this.filters})},clearFilters(){this.filters={categories:[],tags:[],keyword:""}}}};var ha=function(){var t=this,e=t._self._c;return e("section",{staticClass:"filter-section"},[e("div",{staticClass:"container"},[e("div",{staticClass:"filter-card fade-in"},[e("div",{staticClass:"filter-grid"},[e("div",{staticClass:"filter-item"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("books.categoryLabel")))]),e("DropdownFilter",{attrs:{placeholder:t.$t("books.categoryPlaceholder"),options:t.allBookCategories},model:{value:t.filters.categories,callback:function(a){t.$set(t.filters,"categories",a)},expression:"filters.categories"}})],1),e("div",{staticClass:"filter-item"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("books.tagLabel")))]),e("DropdownFilter",{attrs:{placeholder:t.$t("books.tagPlaceholder"),options:t.allBookTags,showChips:!0},model:{value:t.filters.tags,callback:function(a){t.$set(t.filters,"tags",a)},expression:"filters.tags"}})],1),e("div",{staticClass:"filter-item search-box-wrapper"},[e("span",{staticClass:"filter-label"},[t._v(t._s(t.$t("books.keywordLabel")))]),e("div",{staticClass:"search-box"},[e("input",{directives:[{name:"model",rawName:"v-model",value:t.filters.keyword,expression:"filters.keyword"}],staticClass:"search-input",attrs:{type:"text",placeholder:t.$t("books.keywordPlaceholder")},domProps:{value:t.filters.keyword},on:{keyup:function(a){return!a.type.indexOf("key")&&t._k(a.keyCode,"enter",13,a.key,"Enter")?null:t.handleSearch.apply(null,arguments)},input:function(a){a.target.composing||t.$set(t.filters,"keyword",a.target.value)}}}),e("button",{staticClass:"search-btn",on:{click:t.handleSearch}},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"20",height:"20"}},[e("path",{attrs:{fill:"currentColor",d:"M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"}})])])])])]),e("div",{staticClass:"results-bar"},[e("div",{staticClass:"results-count",domProps:{innerHTML:t._s(t.$t("books.resultsCount"))}}),t.hasFilters?e("button",{staticClass:"clear-btn",on:{click:t.clearFilters}},[t._v(t._s(t.$t("books.clear")))]):t._e()])])])])},ga=[],ma=d(ua,ha,ga,!1,null,"ea5616e3",null,null);const va=ma.exports;const ba={name:"BookCard",props:{book:{type:Object,required:!0}}};var wa=function(){var t=this,e=t._self._c;return e("div",{staticClass:"book-card fade-in"},[e("div",{staticClass:"card-cover"},[e("img",{attrs:{src:t.book.cover,alt:t.book.title}}),e("span",{staticClass:"category-badge"},[t._v(t._s(t.book.category))]),t.book.latestChapter?e("span",{staticClass:"chapter-badge"},[t._v(t._s(t.$t("books.latestChapter",{chapter:t.book.latestChapter})))]):t._e()]),e("div",{staticClass:"card-body"},[e("h3",{staticClass:"card-title"},[t._v(t._s(t.book.title))]),e("div",{staticClass:"card-meta"},[e("div",{staticClass:"meta-item"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"14",height:"14"}},[e("path",{attrs:{fill:"currentColor",d:"M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"}})]),e("span",[t._v(t._s(t.book.author))])])]),e("p",{staticClass:"card-excerpt"},[t._v(t._s(t.book.excerpt))]),e("div",{staticClass:"card-tags"},t._l(t.book.tags,function(a){return e("span",{key:a.name,staticClass:"tag",class:"tag-"+a.type},[t._v(t._s(a.name))])}),0),t.book.readUrl||t.book.downloadUrl?e("a",{staticClass:"read-btn",attrs:{href:t.book.readUrl||t.book.downloadUrl,target:"_blank",rel:"noopener"},on:{click:function(a){a.stopPropagation()}}},[t._v(" "+t._s(t.$t("books.read"))+" ")]):t._e()])])},ya=[],ka=d(ba,wa,ya,!1,null,"7c753978",null,null);const fa=ka.exports;const Ca={name:"Books",components:{SiteHeader:y,BookFilterSection:va,BookCard:fa,Pagination:G,SiteFooter:k},data(){return{bookItems:ca,filters:{categories:[],tags:[],keyword:""},currentPage:1,pageSize:10}},computed:{filteredItems(){return this.bookItems.filter(s=>{const t=this.filters.keyword.toLowerCase(),e=!t||s.title.toLowerCase().includes(t)||s.author.toLowerCase().includes(t)||(s.publisher||"").toLowerCase().includes(t)||s.excerpt.toLowerCase().includes(t),a=this.filters.categories.length===0||this.filters.categories.includes(s.category),r=this.filters.tags.length===0||s.tags.some(o=>this.filters.tags.includes(o.name));return e&&a&&r})},totalPages(){return Math.ceil(this.filteredItems.length/this.pageSize)||1},paginatedItems(){const s=(this.currentPage-1)*this.pageSize;return this.filteredItems.slice(s,s+this.pageSize)}},methods:{handleFilterChange(s){this.filters={...s},this.currentPage=1},handlePageChange(s){this.currentPage=s,window.scrollTo({top:0,behavior:"smooth"})}}};var xa=function(){var t=this,e=t._self._c;return e("div",{staticClass:"books-page"},[e("SiteHeader"),e("main",[e("BookFilterSection",{on:{"filter-change":t.handleFilterChange}}),e("section",{staticClass:"container py-40"},[t.paginatedItems.length>0?e("div",[e("div",{staticClass:"grid fade-in"},t._l(t.paginatedItems,function(a){return e("BookCard",{key:a.id,attrs:{book:a}})}),1),e("Pagination",{attrs:{total:t.totalPages,current:t.currentPage,totalItems:t.filteredItems.length,"show-info":!1},on:{change:t.handlePageChange}})],1):e("div",{staticClass:"no-results fade-in"},[e("div",{staticClass:"no-results-content"},[e("svg",{attrs:{viewBox:"0 0 24 24",width:"64",height:"64"}},[e("path",{attrs:{fill:"currentColor",d:"M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"}})]),e("p",[t._v(t._s(t.$t("books.noResults")))])])])])],1),e("SiteFooter")],1)},_a=[],Ua=d(Ca,xa,_a,!1,null,"0ac8a861",null,null);const Aa=Ua.exports;w.use(E);const Ia=[{path:"/",redirect:"/books"},{path:"/home",name:"Home",component:Gt},{path:"/books",name:"Books",component:Aa},{path:"/tools",name:"ToolStation",component:he},{path:"/detail/:slug",name:"ContentDetail",component:ae,props:!0},{path:"/about",name:"AboutUs",component:()=>U(()=>import("./AboutUs-419cc829.js"),["assets/AboutUs-419cc829.js","assets/vue-vendor-b0d8f4d9.js","assets/markdown-98eb5fe8.js","assets/highlight-2a9f9d24.js","assets/ffmpeg-3bd2b020.js","assets/highlight-a597b77c.css","assets/AboutUs-01ffbf2b.css"])},{path:"/privacy-policy",name:"PrivacyPolicy",component:()=>U(()=>import("./PrivacyPolicy-0fa6044a.js"),["assets/PrivacyPolicy-0fa6044a.js","assets/vue-vendor-b0d8f4d9.js","assets/markdown-98eb5fe8.js","assets/highlight-2a9f9d24.js","assets/ffmpeg-3bd2b020.js","assets/highlight-a597b77c.css","assets/PrivacyPolicy-2e535899.css"])}],R=new E({mode:"history",base:"/",routes:Ia,scrollBehavior(){return{x:0,y:0}}});R.afterEach(()=>{document.title="数维探索"});const Sa={nav:{home:"首页",content:"内容",books:"书籍",about:"关于",tools:"在线工具站"},books:{categoryLabel:"分类筛选",categoryPlaceholder:"请选择分类",tagLabel:"标签搜索",tagPlaceholder:"请选择标签",keywordLabel:"关键词搜索",keywordPlaceholder:"搜索书名、作者、出版社...",resultsCount:'共<span class="highlight">29991</span>本，更多书源分享，更多书源分享，访问网址 <a href="https://toolset.site" target="_blank" rel="noopener noreferrer">https://toolset.site</a>',clear:"清空重置",noResults:"未找到匹配的书籍，请尝试更换关键词或清除筛选条件",read:"阅读",latestChapter:"更新至 {chapter}"},header:{login:"登录",register:"注册"},search:{tagLabel:"标签搜索",tagPlaceholder:"请选择标签",collectionLabel:"合集筛选",collectionPlaceholder:"请选择合集",typeLabel:"内容类型",typePlaceholder:"请选择内容类型",keywordLabel:"关键词搜索",keywordPlaceholder:"输入关键词搜索...",resultsCount:"搜索结果：共找到 {total} 个",clear:"清空重置",noResults:"未找到匹配的内容，请尝试更换关键词或清除筛选条件"},pagination:{info:"共 {total} 个，当前第 {current} 页，共 {pages} 页",prev:"上一页",next:"下一页"},footer:{subscribe:"邮件订阅",subscribeDesc:"加入邮件列表，获取最新内容更新和资讯",emailPlaceholder:"请输入您的邮箱地址...",subscribeBtn:"订阅",navTitle:"网站导航",aboutTitle:"关于我们",ecoTitle:"生态",socialTitle:"社交媒体",home:"首页",contentList:"内容列表",userCenter:"用户中心",favorites:"收藏夹",company:"公司介绍",contact:"联系我们",join:"加入我们",privacy:"隐私政策",tools:"在线工具站",blog:"数维探索IT 博客",wiki:"Wiki",tracker:"CSDN 博客"}},Ta={nav:{home:"Home",content:"Content",books:"Books",about:"About",tools:"Online Tools"},books:{categoryLabel:"Category",categoryPlaceholder:"Select Category",tagLabel:"Tags",tagPlaceholder:"Select Tags",keywordLabel:"Keywords",keywordPlaceholder:"Search title, author, publisher...",resultsCount:'共 <span class="highlight">29991</span> books. More sources available. Visit <a href="https://toolset.site" target="_blank" rel="noopener noreferrer">https://toolset.site</a>',clear:"Clear All",noResults:"No books matched your filters. Please try changing keywords or clearing filters.",read:"Read",latestChapter:"Updated to {chapter}"},header:{login:"Log In",register:"Sign Up"},search:{tagLabel:"Tags",tagPlaceholder:"Select Tags",collectionLabel:"Collections",collectionPlaceholder:"Select Collection",typeLabel:"Content Type",typePlaceholder:"Select Type",keywordLabel:"Keywords",keywordPlaceholder:"Search keywords...",resultsCount:"Results: {total} found",clear:"Clear All",noResults:"No content matched your filters. Please try changing keywords or clearing filters."},pagination:{info:"Total {total}, Page {current} of {pages}",prev:"Previous",next:"Next"},footer:{subscribe:"Subscribe",subscribeDesc:"Join our mailing list for the latest updates",emailPlaceholder:"Enter your email address...",subscribeBtn:"Subscribe",navTitle:"Navigation",aboutTitle:"About Us",ecoTitle:"Ecosystem",socialTitle:"Social Media",home:"Home",contentList:"Content List",userCenter:"User Center",favorites:"Favorites",company:"Company Profile",contact:"Contact Us",join:"Join Us",privacy:"Privacy Policy",tools:"Online Tools",blog:"数维探索IT Blog",wiki:"Wiki",tracker:"CSDN Blog"}};w.use(D);const V={zh:Sa,en:Ta},$=localStorage.getItem("language")||"zh",N=Object.keys(V).includes($)?$:"zh";document.documentElement.lang=N==="zh"?"zh-CN":"en-US";const qa=new D({locale:N,fallbackLocale:"zh",messages:V});new w({router:R,i18n:qa,render:s=>s(Y)}).$mount("#app");export{y as S,k as a,d as n};
