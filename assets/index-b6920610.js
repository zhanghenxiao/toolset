...
`+g},{id:2,slug:"antigravity-2026-ban-analysis",title:"Google AI IDE Antigravity 2026大规模封号事件深度解析: 原因与应对策略",image:A,date:"2026-04-07",author:"数维探索",views:"1,000",category:"视频",duration:"08:00",excerpt:"2026年2月12日, 科技圈迎来一次震动, 许多开发者登录 Google 的前沿 AI IDE Antigravity 时, 惊讶地发现自己的账号已被封禁. 这次事件波及范围广泛, 从普通用户到付费的Pro乃至Ultra用户都未能幸免...",tags:[{name:"封号事件",type:"blue"},{name:"AI工具",type:"blue"},{name:"Antigravity",type:"green"}],collection:"AI百科",relatedIds:[3,4,5],recommendationIds:[3,4,6,7],gallery:[A],markdownContent:`
...
`+g},{id:3,slug:"llm-open-source-panic-v2",title:"AI开源大模型LLM的“闭源”恐慌: 一场虚惊还是行业趋势的开端?",image:L,date:"2026-04-07",author:"数维探索",views:"1,500",category:"视频",duration:"06:30",excerpt:"近期，AI 社区中流传着一个令人不安的消息: 许多主流的开源大语言模型（LLM）可能会转向闭源。这个传闻并非空穴来风，本视频将带你深入探究这一话题的来龙去脉。",tags:[{name:"AI趋势",type:"blue"},{name:"LLM",type:"blue"},{name:"开源",type:"green"}],collection:"AI百科",relatedIds:[7,13,14],recommendationIds:[7,12,13,14],gallery:[L],markdownContent:`
...
`+g},{id:4,slug:"cli-proxy-settings-ai-beginners",title:"AI新手必备: 命令行代理设置终极教程(临时与永久)",image:T,date:"2026-04-07",author:"数维探索",views:"2,100",category:"教程",duration:"10:30",excerpt:"在探索AI的世界时，网络限制常是第一道坎。本指南手把手教你如何为命令行设置临时与永久代理，助你高效学习。",tags:[{name:"AI学习",type:"blue"},{name:"命令行",type:"blue"},{name:"代理设置",type:"green"}],collection:"数维探索工具箱",relatedIds:[5,6,7],recommendationIds:[5,6,8,9],gallery:[T],markdownContent:`
...
`},{id:5,slug:"ai-engineer-rules-and-workflows",title:"AI 工程师全局规则与项目规范",image:f,date:"2026-04-07",author:"数维探索",views:"3,200",category:"教程",duration:"15:00",excerpt:"最新发布的 AI 全局开发准则与项目级工作流，涵盖 HTML 与 VUE 工程师的角色职责与标准化技术栈规范。",tags:[{name:"AI工具",type:"blue"},{name:"工作流",type:"blue"},{name:"开发规范",type:"green"}],collection:"数维探索工具箱",relatedIds:[6,7,9],recommendationIds:[6,7,8,10],gallery:[f],markdownContent:`
...
---
专注于分享经过验证的开发技巧与实用资源，致力于为你节省检索信息的时间，以及AI工具经验分享获取更多干货。关注微信公众号：数维探索
`},{id:6,slug:"gemini-3-1-pro-hongkong",title:"重磅消息：Google Gemini 3.1 Pro 正式登陆香港, AI 新时代开启!",image:I,date:"2026-04-07",author:"数维探索",views:"2,800",category:"新闻",duration:"05:45",excerpt:"近日, Google 旗下最先进的大语言模型之一 Gemini 3.1 Pro, 现已通过其 Web 应用正式向香港地区用户开放。",tags:[{name:"Gemini",type:"blue"},{name:"Gemini 3.1 Pro",type:"blue"},{name:"香港",type:"green"}],collection:"AI百科",relatedIds:[7,8,12],recommendationIds:[7,8,9,10],gallery:[I],markdownContent:`
...
---
专注于分享经过验证的开发技巧与实用资源，致力于为你节省检索信息的时间，以及AI工具经验分享获取更多干货。关注微信公众号：数维探索
`},{id:7,slug:"llm-open-source-panic",title:"AI开源大模型LLM的“闭源”恐慌: 一场虚惊还是行业趋势的开端?",image:x,date:"2026-04-07",author:"数维探索",views:"1,500",category:"新闻",duration:"06:30",excerpt:"近期，AI 社区中流传着一个令人不安的消息: 许多主流的开源大语言模型（LLM）可能会转向闭源。这个传闻并非空穴来风，本文将带你深入探究这一话题的来龙去脉。",tags:[{name:"AI趋势",type:"blue"},{name:"LLM",type:"blue"},{name:"开源",type:"green"}],collection:"AI百科",relatedIds:[8,13,14],recommendationIds:[8,12,13,14],gallery:[x],markdownContent:`
# AI开源大模型LLM的“闭源”恐慌: 一场虚惊还是行业趋势的开端?
...
---
专注于分享经过验证的开发技巧与实用资源，致力于为你节省检索信息的时间，以及AI工具经验分享获取更多干货。关注微信公众号：数维探索
`},{id:9,slug:"mapbox-3d-map",title:"Mapbox GL JS 初始化 3D 建筑与地形教程",image:k,date:"2026-04-03",author:"数维探索",views:"1,100",category:"教程",duration:"12:30",excerpt:"学习如何使用 Mapbox GL JS 快速初始化一个包含 3D 建筑挤压（Fill-Extrusion）和数字高程模型（DEM）地形的交互式 3D 地图。",tags:[{name:"Mapbox",type:"blue"},{name:"3D地图",type:"blue"},{name:"WebGIS",type:"green"}],collection:"地图",relatedIds:[10,12,14],recommendationIds:[10,11,12,13],gallery:[k],markdownContent:`
mapbox初始化一个3D地图
...
\`\`\`
`+g},{id:10,slug:"chrome-cors-plugin",title:"Chrome & Firefox 跨域插件配置教程",image:rt,date:"2026-04-02",author:"数维探索",views:"1,800",category:"教程",duration:"08:15",excerpt:"本地开发遇到 Cross-Origin 跨域问题？通过 Chrome 和 Firefox 插件轻松开启 Access-Control-Allow-Origin，加速前后端调试。",tags:[{name:"Chrome",type:"blue"},{name:"插件",type:"blue"},{name:"跨域",type:"green"}],collection:"数维探索工具箱",relatedIds:[11,12,14,15],recommendationIds:[11,12,13,14],gallery:[],markdownContent:`
## 1.Chrome跨域插件配置
...
\`\`\`
`+g},{id:11,slug:"chrome-jsonview-install",title:"Chrome 安装 JSONview 插件教程",image:ot,date:"2026-04-02",author:"数维探索",views:"1,500",category:"教程",duration:"05:00",excerpt:"Chrome 安装 JSONview 插件后，可以在浏览器中直接查看格式化后的 JSON 内容，是开发者必备的工具。",tags:[{name:"Chrome",type:"blue"},{name:"插件",type:"blue"},{name:"JSON",type:"green"}],collection:"数维探索工具箱",relatedIds:[12,13,15],recommendationIds:[12,13,14,15],gallery:["/11/1.png","/11/2.png","/11/3.png","/11/4.png"],markdownContent:`
...
`+g},{id:12,slug:"offline-leaflet-map",title:"Leaflet 离线地图下载与加载教程",image:nt,date:"2026-04-02",author:"数维探索",views:"1,200",category:"教程",duration:"10:00",excerpt:"本教程详细介绍了下载离线地图瓦片的两种方式（osm 和 MapTileDownloader），并提供了在 Leaflet 中加载离线地图的代码示例。",tags:[{name:"Leaflet",type:"blue"},{name:"地图",type:"blue"}],collection:"数维探索工具箱",relatedIds:[22,23,24],recommendationIds:[13,14,15,16],gallery:[],markdownContent:`
